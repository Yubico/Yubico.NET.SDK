...
description: Use when creating or updating CLAUDE.md/README.md for subdirectories (modules, test dirs)
---
...
- Adding a new module/package to the codebase
- Creating a test directory with custom infrastructure
- Setting up a significant subdirectory with its own patterns
- Need to document both human-facing (README) and AI-facing (CLAUDE) guidance
