---
name: yubikit-compare
description: Use when porting between Java YubiKit and C# SDK - byte-level protocol analysis
...
- Porting functionality from yubikit-android (Java) to Yubico.NET.SDK (C#)
- Analyzing implementation differences between Java and C# codebases
- Comparing protocol implementations byte-by-byte
- Need domain expertise on SCP, FIDO, PIV, or smart card protocols
