---
name: jira-create
description: Use when creating bugs, tasks, stories, or epics in Jira
---
...
- Need to create a new Jira issue (Bug, Task, Story, Epic, Sub-task)
- Converting requirements or TODOs into trackable work items
- Programmatically creating issues from agent workflows
