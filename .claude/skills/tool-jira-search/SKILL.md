---
name: jira-search
description: Use when finding issues by filters or discovering project status names
---
...
- Searching for issues by project, status, assignee, or text
- Discovering valid status names for a project
- Finding active work items
- Verifying issue existence before operations
