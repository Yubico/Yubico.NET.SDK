---
name: jira-update
description: Use when editing, transitioning, commenting, or reassigning Jira issues
---
...
- Changing issue status (transitioning through workflow)
- Editing title, description, or other fields
- Adding comments to issues
- Linking issues to epics/parents
- Reassigning issues
