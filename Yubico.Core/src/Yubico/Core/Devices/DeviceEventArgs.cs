...
///     The specific type of <see cref="IDevice" /> this event argument represents.
///     This type parameter is covariant, allowing for more specific device types to be used
///     where a more general device type is expected.
/// </typeparam>
...
/// <summary>
///     Event arguments given whenever a device is added or removed from the system, providing strongly-typed access to the
    ...
    where TDevice : IDevice
{
    ...
    #region IDeviceEventArgs<TDevice> Members
