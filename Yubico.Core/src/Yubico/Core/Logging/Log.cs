...
///     It allows you to configure logging either through a JSON configuration file (
///     <a
///         href="https://learn.microsoft.com/en-us/dotnet/core/extensions/logging?tabs=command-line#configure-logging-without-code">
///         appsettings.json
///     </a>
///     )
...
///     </list>
///     <para>
///         <b>Option 1: Using appsettings.json</b>
///     </para>
///     Place an
///     <c>
///         <a
...
/// </code>
///     <para>
///         <b>Option 2: Using ConfigureLoggerFactory</b>
///     </para>
...
public static partial class Log
{
    ...
    /// <summary>
    ///     Gets or sets the global <see cref="Microsoft.Extensions.Logging.ILoggerFactory" /> instance used for logging
    ...
    private static ILoggerFactory ErrorLoggerFactory =>
