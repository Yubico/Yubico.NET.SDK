...
namespace Yubico.Core.Logging
{
    ...
    /// <remarks>
    ///     <para>
    ///         This class is used for managing the active logger used globally by .NET-based Yubico SDKs in the current
    ///         process.
    ...
    ///         own logger factory, the SDK will use this log from the point of the set until someone calls this set method
    ///         again.
    ///     </para>
    ///     <para>
    ///         <see cref="GetLogger" /> should be used to return an instance of the <see cref="Logger" /> class. This is the
    ///         object
    ///         used to actually write the log messages. It is generally OK to cache an instance of a logger within another
    ///         class instance. Holding a Logger instance open longer than that is not recommended, as changes to the
    ///         LoggerFactory
    ...
    public static class Log
    {
        ...
        ///         [Logging in .NET](https://docs.microsoft.com/en-us/dotnet/core/extensions/logging) webpage provided by
        ///         Microsoft.
        ///     </para>
        /// </remarks>
        /// <example>
