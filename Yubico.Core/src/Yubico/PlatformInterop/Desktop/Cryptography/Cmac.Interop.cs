...
internal static partial class NativeMethods
{
    ...
    [DllImport(
        Libraries.NativeShims, EntryPoint = "Native_EVP_MAC_CTX_free", ExactSpelling = true, CharSet = CharSet.Ansi)]
    [DefaultDllImportSearchPaths(DllImportSearchPath.SafeDirectories)]
    ...
    //   3 - AES-256-CBC
    [DllImport(
        Libraries.NativeShims, EntryPoint = "Native_CMAC_EVP_MAC_init", ExactSpelling = true, CharSet = CharSet.Ansi)]
    [DefaultDllImportSearchPaths(DllImportSearchPath.SafeDirectories)]
    ...
    // This returns 1 for success, or 0 for an error.
    [DllImport(
        Libraries.NativeShims, EntryPoint = "Native_CMAC_EVP_MAC_update", ExactSpelling = true, CharSet = CharSet.Ansi)]
    [DefaultDllImportSearchPaths(DllImportSearchPath.SafeDirectories)]
    ...
    // This returns 1 for success, or 0 for an error.
    [DllImport(
        Libraries.NativeShims, EntryPoint = "Native_CMAC_EVP_MAC_final", ExactSpelling = true, CharSet = CharSet.Ansi)]
    [DefaultDllImportSearchPaths(DllImportSearchPath.SafeDirectories)]
