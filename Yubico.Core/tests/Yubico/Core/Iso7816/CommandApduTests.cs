...
public class CommandApduTests
{
    ...
    //
    private static byte[] GenerateRandBytes(
        int length)
    {
    ...
    public void Ne_GetAfterSet_ReturnsSameValue(
        int ne)
    {
        var commandApdu = new CommandApdu
        {
    ...
    public void AsByteArray_HeaderSetNeSet_EmitsCorrectApduShort(
        int ne,
        byte[] expectedLe)
    {
    ...
    public void AsByteArray_HeaderSetNeSet_EmitsCorrectApduExtended(
        int ne,
        byte[] expectedLe)
    {
        var expectedByteArray = new List<byte>();
    ...
    [InlineData(0x12, new byte[] { 0x12 })]
    [InlineData(_MaximumSizeShortEncoding, new byte[] { 0x00 })]
    public void AsByteArray_HeaderSetDataSet_EmitsCorrectApduShort(
        int nc,
        byte[] expectedLc)
    {
    ...
    [InlineData(0x1234, new byte[] { 0x00, 0x12, 0x34 })]
    [InlineData(_MaximumSizeExtendedEncoding, new byte[] { 0x00, 0x00, 0x00 })]
    public void AsByteArray_HeaderSetDataSet_EmitsCorrectApduExtended(
        int nc,
        byte[] expectedLc)
    {
        var data = GenerateRandBytes(nc);
    ...
    public void AsShortByteArray_NcAndOrNeInvalidSize_ThrowsInvalidOperationException(
        int nc,
        int ne)
    {
    ...
    {
        var nc = 1;
        var expectedLc = new byte[] { 0x00, 0x00, 0x01 };
        var ne = 1;
        var expectedLe = new byte[] { 0x00, 0x01 };
        var data = GenerateRandBytes(nc);
    ...
    public void AsExtendedByteArray_NcAndOrNeInvalidSize_ThrowsInvalidOperationException(
        int nc,
        int ne)
    {
        var data = new byte[nc];
    ...
    public void AsEncodingByteArray_NeSetIntMaxValue_EmitsCorrectApduMaxNe(
