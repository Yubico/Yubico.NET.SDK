    ...
    public partial class CborReader
    {
        ...
        private ulong PeekUnsignedInteger(out int bytesRead)
        {
            ...
            switch (header.MajorType)
            {
                ...
                default:
                    throw new InvalidOperationException(string.Format(CultureInfo.CurrentCulture, CborExceptionMessages.Cbor_Reader_MajorTypeMismatch, (int)header.MajorType));
            }
        }
        ...
        private ulong DecodeUnsignedInteger(CborInitialByte header, ReadOnlySpan<byte> data, out int bytesRead)
        {
            ...
            switch (header.AdditionalInfo)
            {
                ...
                default:
                    throw new CborContentException(CborExceptionMessages.Cbor_Reader_InvalidCbor_InvalidIntegerEncoding);
            }
            ...
            void ValidateIsNonStandardIntegerRepresentationSupported()
            {
                ...
                {
                    throw new CborContentException(string.Format(CultureInfo.CurrentCulture, CborExceptionMessages.Cbor_ConformanceMode_NonCanonicalIntegerRepresentation, ConformanceMode));
                }
            }
        }
    }
