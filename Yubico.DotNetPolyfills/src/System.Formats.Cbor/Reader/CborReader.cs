...
namespace System.Formats.Cbor
{
    ...
    public partial class CborReader
    {
        ...
        public ReadOnlyMemory<byte> ReadEncodedValue(bool disableConformanceModeChecks = false)
        {
            ...
            return _data[initialOffset.._offset];
        }
        ...
        private CborInitialByte PeekInitialByte()
        {
            ...
            {
                throw new InvalidOperationException(CborExceptionMessages.Cbor_Reader_NoMoreDataItemsToRead);
            }
            ...
            if (_offset == _data.Length)
            {
                ...
                throw new CborContentException(CborExceptionMessages.Cbor_Reader_InvalidCbor_UnexpectedEndOfBuffer);
            }
            ...
            switch (_currentMajorType)
            {
                ...
                case CborMajorType.TextString:
                    ...
                    throw new CborContentException(string.Format(CultureInfo.CurrentCulture, CborExceptionMessages.Cbor_Reader_InvalidCbor_IndefiniteLengthStringContainsInvalidDataItem, (int)nextByte.MajorType));
            }
        ...
        private CborInitialByte PeekInitialByte(CborMajorType expectedType)
        {
            ...
            {
                throw new InvalidOperationException(string.Format(CultureInfo.CurrentCulture, CborExceptionMessages.Cbor_Reader_MajorTypeMismatch, (int)result.MajorType));
            }
        ...
        private void ValidateNextByteIsBreakByte()
        {
            ...
            {
                throw new InvalidOperationException(CborExceptionMessages.Cbor_NotAtEndOfIndefiniteLengthDataItem);
            }
        }
        ...
        private void PopDataItem(CborMajorType expectedType)
        {
            ...
            {
                throw new InvalidOperationException(string.Format(CultureInfo.CurrentCulture, CborExceptionMessages.Cbor_PopMajorTypeMismatch, (int)_currentMajorType.Value));
            }
            ...
            if (_isTagContext)
            {
                throw new CborContentException(CborExceptionMessages.Cbor_Reader_InvalidCbor_TagNotFollowedByValue);
            }
        ...
        private void RestoreCheckpoint(in Checkpoint checkpoint)
        {
            ...
            if (_keyEncodingRanges != null && _itemsRead > checkpoint.ItemsRead)
            {
                ...
                _ = _keyEncodingRanges.RemoveWhere(key => key.Offset >= checkpointOffset);
            }
