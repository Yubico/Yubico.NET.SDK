    ...
    public partial class CborWriter
    {
        ...
        private void WriteUnsignedInteger(CborMajorType type, ulong value)
        {
            ...
            else if (value <= ushort.MaxValue)
            {
                ...
                BinaryPrimitives.WriteUInt16BigEndian(_buffer.AsSpan(BytesWritten), (ushort)value);
            ...
            else if (value <= uint.MaxValue)
            {
                ...
                BinaryPrimitives.WriteUInt32BigEndian(_buffer.AsSpan(BytesWritten), (uint)value);
            ...
            else
            {
                ...
                BinaryPrimitives.WriteUInt64BigEndian(_buffer.AsSpan(BytesWritten), value);
