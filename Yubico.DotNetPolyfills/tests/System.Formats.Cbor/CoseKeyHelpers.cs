...
namespace System.Formats.Cbor.UnitTests
{
    ...
    public static class CborCoseKeyHelpers
    {
        ...
        private static void WriteECParametersAsCosePublicKey(CborWriter writer, ECParameters ecParams, HashAlgorithmName? algorithmName)
        {
            ...
            {
                throw new ArgumentException(CborExceptionMessages.Cbor_CoseKeyError, nameof(ecParams));
            }
            ...
            static CoseKeyAlgorithm MapHashAlgorithmNameToCoseKeyAlg(HashAlgorithmName name)
            {
                ...
                throw new ArgumentException(CborExceptionMessages.Cbor_CoseKeyError, nameof(name));
        ...
        private static (ECParameters, HashAlgorithmName?) ReadECParametersAsCosePublicKey(CborReader reader)
        {
            ...
            try
            {
                ...
                var kty = (CoseKeyType)reader.ReadInt32();

                HashAlgorithmName? algName = null;
                if (TryReadCoseKeyLabel(CoseKeyLabel.Alg))
                {
                    var alg = (CoseKeyAlgorithm)reader.ReadInt32();
                ...
                var crv = (CoseCrvId)reader.ReadInt32();
            ...
            static ECCurve MapCoseCrvToECCurve(CoseCrvId crv)
            {
                return crv switch
                {
                    ...
                    CoseCrvId.X255519 => throw new NotImplementedException("OKP type curves not implemented."),
                    CoseCrvId.X448 => throw new NotImplementedException("OKP type curves not implemented."),
                    CoseCrvId.Ed25519 => throw new NotImplementedException("OKP type curves not implemented."),
