...
namespace System.Formats.Cbor.UnitTests
{
    public partial class CborWriterTests
    {
        ...
        public static void WriteTag_NoValueInNestedContext_ShouldThrowInvalidOperationException()
        {
            ...
            _ = Assert.Throws<InvalidOperationException>(() => writer.WriteEndArray());
        }
        ...
        {
            var value = DateTimeOffset.Parse(valueString, CultureInfo.InvariantCulture);
            var writer = new CborWriter();
        ...
        {
            var writer = new CborWriter();
            _ = Assert.Throws<ArgumentException>(() => writer.WriteUnixTimeSeconds(value));
        }
        ...
        {
            var value = BigInteger.Parse(valueString, CultureInfo.InvariantCulture);
        ...
        public static void WriteTaggedValue_UnsupportedConformance_ShouldThrowInvalidOperationException(CborConformanceMode mode, object value)
        {
            ...
            _ = Assert.Throws<InvalidOperationException>(() => Helpers.WriteValue(writer, value));
