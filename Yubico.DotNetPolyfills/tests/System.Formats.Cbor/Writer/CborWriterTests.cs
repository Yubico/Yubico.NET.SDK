...
namespace System.Formats.Cbor.UnitTests
{
    ...
    [System.Diagnostics.CodeAnalysis.SuppressMessage("Globalization", "CA1304:Specify CultureInfo", Justification = "External code")]
    [System.Diagnostics.CodeAnalysis.SuppressMessage("Design", "CA1062:Validate arguments of public methods", Justification = "External code")]
    public partial class CborWriterTests
    {
        ...
        {
            var writer = new CborWriter();
            _ = Assert.Throws<InvalidOperationException>(() => writer.Encode());
        }
        ...
        public static void CborWriter_WritingTwoPrimitiveValues_ShouldThrowInvalidOperationException()
        {
            ...
            _ = Assert.Throws<InvalidOperationException>(() => writer.WriteTextString("lorem ipsum"));
        ...
        public static void EncodeSpan_DestinationTooSmall_ShouldThrowArgumentException(object value)
        {
            ...
            _ = Assert.Throws<ArgumentException>(() => writer.Encode(target));
        ...
        public static void WriteEncodedValue_BadIndefiniteLengthStringValue_ShouldThrowInvalidOperationException()
        {
            var writer = new CborWriter();
            writer.WriteStartIndefiniteLengthTextString();
            _ = Assert.Throws<InvalidOperationException>(() => writer.WriteEncodedValue(new byte[] { 0x01 }));
        }
        ...
        public static void WriteEncodedValue_InvalidCbor_ShouldThrowArgumentException(string hexEncodedInput)
        {
            ...
            var writer = new CborWriter();
            _ = Assert.Throws<ArgumentException>(() => writer.WriteEncodedValue(encodedInput));
        }
        ...
        {
            var writer = new CborWriter();
            _ = Assert.Throws<ArgumentException>(() => writer.WriteEncodedValue(new byte[] { 0x01, 0x01 }));
        }
        ...
        {
            _ = Assert.Throws<ArgumentOutOfRangeException>(() => new CborWriter(conformanceMode: mode));
        }
        ...
        {
            byte[] expectedEncoding = expectedHexEncoding.HexToByteArray();
            HashAlgorithmName? hashAlgName = hashAlgorithmName != null ? new HashAlgorithmName(hashAlgorithmName) : (HashAlgorithmName?)null;
