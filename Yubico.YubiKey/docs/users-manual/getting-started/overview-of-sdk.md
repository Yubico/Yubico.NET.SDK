...
YubiHSM Auth uses hardware to protect these long-lived credentials. This increases the security of the authentication credentials, as compared to the Password-Based Key Derivation Function 2 (PBKDF2) algorithm which requires the user to manually enter a password.
