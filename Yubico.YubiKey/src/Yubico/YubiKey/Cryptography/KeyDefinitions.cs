...
// Ideally, Cose definitions should move to this namespace
...
public static class KeyDefinitions
{
    ...
    /// </summary>
    public static readonly KeyDefinition P256 = new()
    {
    ...
    /// </summary>
    public static readonly KeyDefinition P384 = new()
    {
    ...
    /// </summary>
    public static readonly KeyDefinition P521 = new()
    {
    ...
    /// </summary>
    public static readonly KeyDefinition X25519 = new()
    {
    ...
    /// </summary>
    public static readonly KeyDefinition Ed25519 = new()
    {
    ...
    /// </summary>
    public static readonly KeyDefinition RSA1024 = new()
    {
    ...
    /// </summary>
    public static readonly KeyDefinition RSA2048 = new()
    {
    ...
    /// </summary>
    public static readonly KeyDefinition RSA3072 = new()
    {
    ...
    /// </summary>
    public static readonly KeyDefinition RSA4096 = new()
    {
    ...
    /// </summary>
    public static readonly KeyDefinition AES128 = new()
    {
    ...
    /// </summary>
    public static readonly KeyDefinition AES192 = new()
    {
    ...
    /// </summary>
    public static readonly KeyDefinition AES256 = new()
    {
    ...
    /// </summary>
    public static readonly KeyDefinition TripleDes = new()
    {
    ...
    public static KeyDefinition GetByCoseCurve(CoseEcCurve curve) =>
        AllDefinitions.Values.SingleOrDefault(d =>
            d.CoseKeyDefinition != null && d.CoseKeyDefinition.CurveIdentifier == curve)
