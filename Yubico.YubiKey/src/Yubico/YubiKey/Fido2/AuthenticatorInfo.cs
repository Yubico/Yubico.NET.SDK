...
public class AuthenticatorInfo
{
    ...
    /// <summary>
    ///     If present, indicates whether the authenticator is enforcing an additional current PIN complexity policy beyond
    ///     minPINLength.
    ///     If <c>true</c>, the authenticator is enforcing a PIN complexity policy.
    ///     If <c>false</c>, the authenticator is not enforcing a PIN complexity policy.
    ///     If <c>null</c>, the authenticator does not support this feature.
    ...
    /// <summary>
    ///     Retrieves the identifier derived from the encrypted identifier, using the provided persistent UV authentication
    ///     token.
    /// </summary>
