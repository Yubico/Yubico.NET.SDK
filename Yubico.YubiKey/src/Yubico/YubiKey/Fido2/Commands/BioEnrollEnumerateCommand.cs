...
public sealed class BioEnrollEnumerateCommand : IYubiKeyCommand<BioEnrollEnumerateResponse>
{
    ...
    #region IYubiKeyCommand<BioEnrollEnumerateResponse> Members
    ...
    /// <inheritdoc />
    public BioEnrollEnumerateResponse CreateResponseForApdu(ResponseApdu responseApdu) => new(responseApdu);
