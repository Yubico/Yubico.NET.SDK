...
public class ConfigCommand : IYubiKeyCommand<ConfigResponse>
{
        ...
        PinUvAuthProtocolBase authProtocol)
    {
        ...
        message.AsSpan().Fill(0xFF);
        message[32] = CmdAuthenticatorConfig;
    ...
    #region IYubiKeyCommand<ConfigResponse> Members
    ...
    /// <inheritdoc />
    public ConfigResponse CreateResponseForApdu(ResponseApdu responseApdu) => new(responseApdu);
