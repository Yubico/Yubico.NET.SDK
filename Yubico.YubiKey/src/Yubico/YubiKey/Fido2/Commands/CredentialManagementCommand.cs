...
public class CredentialManagementCommand : IYubiKeyCommand<CredentialManagementResponse>
{
    ...
    #region IYubiKeyCommand<CredentialManagementResponse> Members
    ...
    /// <inheritdoc />
    public CredentialManagementResponse CreateResponseForApdu(ResponseApdu responseApdu) => new(responseApdu);
