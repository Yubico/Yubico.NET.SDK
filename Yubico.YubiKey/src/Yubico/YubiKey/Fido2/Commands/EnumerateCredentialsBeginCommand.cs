                                                ...
                                                IYubiKeyCommand<EnumerateCredentialsBeginResponse>
{
    ...
    #region IYubiKeyCommand<EnumerateCredentialsBeginResponse> Members

    /// <inheritdoc />
    public EnumerateCredentialsBeginResponse CreateResponseForApdu(ResponseApdu responseApdu) => new(responseApdu);
