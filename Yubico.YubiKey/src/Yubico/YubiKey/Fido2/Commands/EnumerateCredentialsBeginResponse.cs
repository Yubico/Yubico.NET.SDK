    ...
    : Fido2Response, IYubiKeyResponseWithData<(int credentialCount, CredentialUserInfo credentialUserInfo)>
{
    ...
    #region IYubiKeyResponseWithData<(int credentialCount, CredentialUserInfo credentialUserInfo)> Members
    ...
    public (int credentialCount, CredentialUserInfo credentialUserInfo) GetData()
    {
        ...
        if (credentialManagementData.TotalCredentialsForRelyingParty is not null
            && credentialManagementData.User is not null
