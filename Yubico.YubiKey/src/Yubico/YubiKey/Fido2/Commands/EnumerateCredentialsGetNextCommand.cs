                                                  ...
                                                  IYubiKeyCommand<EnumerateCredentialsGetNextResponse>
{
    ...
    /// <summary>
    ///     Constructs a new instance of <see cref="EnumerateCredentialsGetNextCommand" /> with a pre-computed PIN/UV auth
    ///     param.
    /// </summary>
    ...
    #region IYubiKeyCommand<EnumerateCredentialsGetNextResponse> Members

    /// <inheritdoc />
    public EnumerateCredentialsGetNextResponse CreateResponseForApdu(ResponseApdu responseApdu) => new(responseApdu);
