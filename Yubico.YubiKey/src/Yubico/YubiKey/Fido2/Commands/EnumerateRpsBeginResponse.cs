    ...
    : Fido2Response, IYubiKeyResponseWithData<(int totalRelyingPartyCount, RelyingParty relyingParty)>
{
    ...
    #region IYubiKeyResponseWithData<(int totalRelyingPartyCount, RelyingParty relyingParty)> Members
    ...
    public (int totalRelyingPartyCount, RelyingParty relyingParty) GetData()
    {
        ...
        {
            if (credentialManagementData.RelyingParty.IsMatchingRelyingPartyId(
                    credentialManagementData.RelyingPartyIdHash.Value))
            {
