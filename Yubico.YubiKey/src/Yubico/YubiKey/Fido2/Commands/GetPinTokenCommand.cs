...
public class GetPinTokenCommand : IYubiKeyCommand<GetPinUvAuthTokenResponse>
{
    ...
    #region IYubiKeyCommand<GetPinUvAuthTokenResponse> Members
    ...
    /// <inheritdoc />
    public GetPinUvAuthTokenResponse CreateResponseForApdu(ResponseApdu responseApdu) => new(responseApdu);
