...
///     </para>
///     <para>
///         Before attempting to reset a YubiKey Bio Multi-protocol Edition key with ResetCommand(), verify that the FIDO2
///         application is not blocked from using this method by checking the
///         <see cref="IYubiKeyDeviceInfo.ResetBlocked" /> property. If the application is blocked, use
///         <see cref="IYubiKeyDevice.DeviceReset" />.
///     </para>
/// </remarks>
public class ResetCommand : IYubiKeyCommand<ResetResponse>
{
    ...
    #region IYubiKeyCommand<ResetResponse> Members
    ...
    /// <inheritdoc />
    public ResetResponse CreateResponseForApdu(ResponseApdu responseApdu) => new(responseApdu);
