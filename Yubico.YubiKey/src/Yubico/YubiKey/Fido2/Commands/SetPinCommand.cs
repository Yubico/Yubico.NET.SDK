...
namespace Yubico.YubiKey.Fido2.Commands
{
    ...
    /// change a PIN, use the ChangePinCommand. To remove a PIN, reset the
    /// application. Note that resetting the application will mean losing all
    /// credentials as well as removing the PIN.
    /// </para>
    /// </remarks>
    public class SetPinCommand : IYubiKeyCommand<SetPinResponse>
    {
        ...
        public SetPinCommand(PinUvAuthProtocolBase pinProtocol, ReadOnlyMemory<byte> newPin)
        {
            ...
            byte[] encryptedPin = pinProtocol.Encrypt(dataToEncrypt);
