...
public sealed partial class Fido2Session
{
        ...
        string? relyingPartyId = null)
    {
        ...
        {
            AddPermissions(PinUvAuthTokenPermissions.None);
        }
    ...
    ///         <list type="bullet">
    ///             <item>
    ///                 <description>It must be encoded in UTF-8 with Normalization Form C.</description>
    ///             </item>
    ///             <item>
    ///                 <description>It must be at least 4 Unicode code points in length.</description>
    ///             </item>
    ///             <item>
    ///                 <description>It must not exceed 63 bytes in encoded length.</description>
    ///             </item>
    ///         </list>
    ...
    ///     <list type="bullet">
    ///         <item>
    ///             <description>Must be encoded in UTF-8 with Normalization Form C.</description>
    ///         </item>
    ///         <item>
    ///             <description>Must be at least 4 Unicode code points in length.</description>
    ///         </item>
    ///         <item>
    ///             <description>Must not exceed 63 bytes in encoded length.</description>
    ///         </item>
    ///     </list>
    ///     Read more about PINs <xref href="TheFido2Pin">here</xref>.
    /// </param>
