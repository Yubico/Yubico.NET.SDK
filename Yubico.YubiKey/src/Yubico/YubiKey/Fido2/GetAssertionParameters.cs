...
public class GetAssertionParameters : AuthenticatorOperationParameters<GetAssertionParameters>
{
    ...
    ///     </para>
    /// </remarks>
    public void RequestCredBlobExtension() => AddExtension(Fido2ExtensionKeys.CredBlob, true);
    ...
    /// </remarks>
    public void RequestThirdPartyPayment() => AddExtension(Fido2ExtensionKeys.ThirdPartyPayment, true);
