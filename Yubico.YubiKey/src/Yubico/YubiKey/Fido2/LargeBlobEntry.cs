...
public class LargeBlobEntry
{
    ...
    public bool TryDecrypt(ReadOnlyMemory<byte> largeBlobKey, out Memory<byte> plaintext)
    {
        ...
        try
        {
            ...
            BinaryPrimitives.WriteInt64LittleEndian(associatedData[AssociatedSizeOffset..], OriginalDataLength);
            ...
            bool decryptSuccess = decryptoAlgorithm.DecryptAndVerify(
                ...
                Ciphertext[..dataToDecryptLength].Span,
    ...
    private ReadOnlyMemory<byte> EncryptBlobData(ReadOnlyMemory<byte> blobData, ReadOnlyMemory<byte> largeBlobKey)
    {
        ...
        try
        {
            ...
            BinaryPrimitives.WriteInt64LittleEndian(
                associatedData[AssociatedSizeOffset..], blobData.Length);
