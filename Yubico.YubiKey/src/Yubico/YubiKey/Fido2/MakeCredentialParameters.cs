...
public class MakeCredentialParameters : AuthenticatorOperationParameters<MakeCredentialParameters>
{
    ...
    private readonly List<Tuple<string, CoseAlgorithmIdentifier>> _algorithms = new();
    ...
    /// </remarks>
    public void AddThirdPartyPaymentExtension() => AddExtension(Fido2ExtensionKeys.ThirdPartyPayment, true);
