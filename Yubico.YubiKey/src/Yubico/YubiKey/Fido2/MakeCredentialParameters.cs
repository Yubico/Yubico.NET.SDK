    ...
    public class MakeCredentialParameters : ICborEncode
    {
        ...
        public byte[] CborEncode() =>
            new CborMapWriter<int>()
                ...
                .OptionalEntry(
                    TagExtensions, ParameterHelpers.EncodeKeyValues, _extensions)
        ...
        public void AddExtension(string extensionKey, byte[] encodedValue) =>
            _extensions =
                ParameterHelpers.AddKeyValue(extensionKey, encodedValue, _extensions);
            ...
            AuthenticatorInfo authenticatorInfo)
        {
            ...
            AddExtension(KeyCredProtect, new[] { (byte)credProtectPolicy });
        }
        ...
        public void AddOption(string optionKey, bool optionValue) =>
            _options =
                ParameterHelpers.AddKeyValue(optionKey, optionValue, _options);
