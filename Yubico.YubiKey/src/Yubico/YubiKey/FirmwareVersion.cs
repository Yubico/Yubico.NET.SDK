...
namespace Yubico.YubiKey
{
    public class FirmwareVersion : IComparable<FirmwareVersion>, IComparable, IEquatable<FirmwareVersion>
    {
        ...
        internal static readonly FirmwareVersion All = new FirmwareVersion(major: 1);
        internal static readonly FirmwareVersion V2_0_0 = new FirmwareVersion(major: 2);
        internal static readonly FirmwareVersion V2_1_0 = new FirmwareVersion(major: 2, minor: 1);
        internal static readonly FirmwareVersion V2_2_0 = new FirmwareVersion(major: 2, minor: 2);
        internal static readonly FirmwareVersion V2_3_0 = new FirmwareVersion(major: 2, minor: 3);
        internal static readonly FirmwareVersion V2_3_2 = new FirmwareVersion(major: 2, minor: 3, patch: 2);
        internal static readonly FirmwareVersion V2_4_0 = new FirmwareVersion(major: 2, minor: 4);
        internal static readonly FirmwareVersion V3_1_0 = new FirmwareVersion(major: 3, minor: 1);
        internal static readonly FirmwareVersion V4_0_0 = new FirmwareVersion(major: 4);
        internal static readonly FirmwareVersion V4_2_4 = new FirmwareVersion(major: 4, minor: 2, patch: 4);
        internal static readonly FirmwareVersion V4_3_0 = new FirmwareVersion(major: 4, minor: 3);
        ...
        internal static readonly FirmwareVersion V4_4_0 = new FirmwareVersion(major: 4, minor: 4);
        internal static readonly FirmwareVersion V4_5_0 = new FirmwareVersion(major: 4, minor: 5);
        internal static readonly FirmwareVersion V5_0_0 = new FirmwareVersion(major: 5);
        internal static readonly FirmwareVersion V5_3_0 = new FirmwareVersion(major: 5, minor: 3);
        ...
        internal static readonly FirmwareVersion V5_6_0 = new FirmwareVersion(major: 5, minor: 6);
        internal static readonly FirmwareVersion V5_7_0 = new FirmwareVersion(major: 5, minor: 7);
