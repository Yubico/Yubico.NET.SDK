...
public class FirmwareVersion : IComparable<FirmwareVersion>, IComparable, IEquatable<FirmwareVersion>
{
    ...
    internal static readonly FirmwareVersion V2_0_0 = new(2);
    internal static readonly FirmwareVersion V2_1_0 = new(2, 1);
    internal static readonly FirmwareVersion V2_2_0 = new(2, 2);
    internal static readonly FirmwareVersion V2_3_0 = new(2, 3);
    internal static readonly FirmwareVersion V2_3_2 = new(2, 3, 2);
    internal static readonly FirmwareVersion V2_4_0 = new(2, 4);
    internal static readonly FirmwareVersion V3_1_0 = new(3, 1);
    internal static readonly FirmwareVersion V4_0_0 = new(4);
    internal static readonly FirmwareVersion V4_2_4 = new(4, 2, 4);
    internal static readonly FirmwareVersion V4_3_0 = new(4, 3);
    internal static readonly FirmwareVersion V4_3_1 = new(4, 3, 1);
    internal static readonly FirmwareVersion V4_3_4 = new(4, 3, 4);
    internal static readonly FirmwareVersion V4_4_0 = new(4, 4);
    internal static readonly FirmwareVersion V4_5_0 = new(4, 5);
