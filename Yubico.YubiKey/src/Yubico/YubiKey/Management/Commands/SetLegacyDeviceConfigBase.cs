...
namespace Yubico.YubiKey.Management.Commands
{
    ...
    public class SetLegacyDeviceConfigBase
    {
        private static readonly Dictionary<YubiKeyCapabilities, byte> _interfaceCodes =
            new Dictionary<YubiKeyCapabilities, byte>
            {
        ...
        /// <list type="bullet">
        /// <item><see cref="YubiKeyCapabilities.Otp"/></item>
        /// <item><see cref="YubiKeyCapabilities.Ccid"/></item>
        /// <item><see cref="YubiKeyCapabilities.FidoU2f"/></item>
        /// <item><see cref="YubiKeyCapabilities.All"/></item>
        /// </list>
        /// </UsbInterfaceRestrictions>
        /// </para>
        /// </remarks>
