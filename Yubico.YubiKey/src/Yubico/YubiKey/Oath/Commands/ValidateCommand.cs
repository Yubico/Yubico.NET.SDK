...
public class ValidateCommand : OathChallengeResponseBaseCommand, IYubiKeyCommand<ValidateResponse>
{
    ...
    #region IYubiKeyCommand<ValidateResponse> Members
    ...
    /// <inheritdoc />
    public ValidateResponse CreateResponseForApdu(ResponseApdu responseApdu) => new(responseApdu, CalculatedResponse);
