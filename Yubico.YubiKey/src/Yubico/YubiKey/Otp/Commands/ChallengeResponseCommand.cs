...
public class ChallengeResponseCommand : IYubiKeyCommand<ChallengeResponseResponse>
{
    ...
    #region IYubiKeyCommand<ChallengeResponseResponse> Members
    ...
    /// <inheritdoc />
    public ChallengeResponseResponse CreateResponseForApdu(ResponseApdu responseApdu) => new(responseApdu, Algorithm);
