...
public class ConfigureStaticPassword : OperationBase<ConfigureStaticPassword>
{
    ...
    public ConfigureStaticPassword AppendDelayToFixed(bool setConfig = true) => Settings.AppendDelayToFixed(setConfig);
    ...
    public ConfigureStaticPassword AllowManualUpdate(bool setConfig = true) => Settings.AllowManualUpdate(setConfig);
