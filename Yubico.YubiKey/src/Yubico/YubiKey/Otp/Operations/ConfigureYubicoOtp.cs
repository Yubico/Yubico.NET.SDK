...
public class ConfigureYubicoOtp : OperationBase<ConfigureYubicoOtp>
{
    ...
    ///         validate this or it will fail.
    ///     </para>
    ///     <para>
    ///         Setting an explicit public ID is not compatible with using the YubiKey serial
    ...
    /// <returns>The current <see cref="ConfigureYubicoOtp" /> instance.</returns>
    public ConfigureYubicoOtp AppendCarriageReturn(bool setConfig = true) => Settings.AppendCarriageReturn(setConfig);
