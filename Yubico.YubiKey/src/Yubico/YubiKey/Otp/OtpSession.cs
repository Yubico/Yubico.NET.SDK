...
public sealed class OtpSession : ApplicationSession, IOtpSession
{
    ...
    ///     An instance of <see cref="Scp03KeyParameters" /> containing the
    ///     parameters for the SCP03 key. If <see langword="null" />, the default parameters will be used.
    /// </param>
    ...
    public CalculateChallengeResponse CalculateChallengeResponse(Slot slot) => new(Connection, this, slot);
    ...
    public ConfigureYubicoOtp ConfigureYubicoOtp(Slot slot) => new(Connection, this, slot);
    ...
    public DeleteSlotConfiguration DeleteSlotConfiguration(Slot slot) => new(Connection, this, slot);
    ...
    public ConfigureChallengeResponse ConfigureChallengeResponse(Slot slot) => new(Connection, this, slot);

    /// <inheritdoc cref="Operations.ConfigureHotp" />
    /// <param name="slot">OTP Slot to configure.</param>
    public ConfigureHotp ConfigureHotp(Slot slot) => new(Connection, this, slot);

    /// <inheritdoc cref="Operations.ConfigureNdef" />
    /// <param name="slot">OTP Slot to configure.</param>
    public ConfigureNdef ConfigureNdef(Slot slot) => new(Connection, this, slot);
    ...
    public ConfigureStaticPassword ConfigureStaticPassword(Slot slot) => new(Connection, this, slot);
    ...
    public UpdateSlot UpdateSlot(Slot slot) => new(Connection, this, slot);
