    ...
    internal static class CtapToApduResponse
    {
        ...
        public static ResponseApdu ToCtap1ResponseApdu(Span<byte> responseData)
        {
            ...
            short statusWord =
                errorCode switch
                {
                    (byte)U2fHidStatus.Ctap1ErrInvalidCommand => SWConstants.CommandNotAllowed,
                    (byte)U2fHidStatus.Ctap1ErrInvalidParameter => SWConstants.InvalidParameter,
                    (byte)U2fHidStatus.Ctap1ErrInvalidLength => SWConstants.WrongLength,
