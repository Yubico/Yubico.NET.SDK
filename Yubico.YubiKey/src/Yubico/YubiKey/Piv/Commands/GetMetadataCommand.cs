...
public sealed class GetMetadataCommand : IYubiKeyCommand<GetMetadataResponse>
{
    ...
    public byte SlotNumber
    {
        ...
        set
        {
            if (!PivSlot.IsValidSlotNumber(value))
            {
    ...
    #region IYubiKeyCommand<GetMetadataResponse> Members
    ...
    {
        if (!PivSlot.IsValidSlotNumber(_slotNumber))
        {
    ...
    /// <inheritdoc />
    public GetMetadataResponse CreateResponseForApdu(ResponseApdu responseApdu) => new(responseApdu, SlotNumber);
