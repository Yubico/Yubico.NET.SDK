...
public sealed class ImportAsymmetricKeyCommand : IYubiKeyCommand<ImportAsymmetricKeyResponse>
{
    ...
    #region IYubiKeyCommand<ImportAsymmetricKeyResponse> Members
    ...
    /// <inheritdoc />
    public ImportAsymmetricKeyResponse CreateResponseForApdu(ResponseApdu responseApdu) => new(responseApdu);
