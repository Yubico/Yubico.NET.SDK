...
///     </para>
///     <para>
///         Upon manufacture of a YubiKey, the management key is either a Triple-DES key (firmware prior to 5.7) or an
///         AES-192 key (firmware 5.7 and later), and
...
///             <item>
///                 <term>
///                     Compute <c>Client Authentication Response</c> based on <c>Client Authentication Challenge</c>
///                 </term>
///                 <description></description>
///             </item>
///             <item>
...
///                 <term></term>
///                 <description>
///                     <b>Response APDU</b><br /> contains no data<br />Status is either
///                     Success or AuthenticationRequired
///                 </description>
///             </item>
///         </list>
///     </para>
...
///             <item>
///                 <term>
///                     <b>Command APDU</b><br /> contains <c>Client Authentication Response</c> and
///                     <c>YubiKey Authentication Challenge</c>
///                 </term>
///                 <description></description>
///             </item>
///             <item>
...
///                 <term></term>
///                 <description>
///                     Compute <c>YubiKey Authentication Response</c> based on
///                     <c>YubiKey Authentication Challenge</c>
///                 </description>
///             </item>
///             <item>
///                 <term></term>
///                 <description>
///                     <b>Response APDU</b><br />Status is either Success or
///                     AuthenticationRequired<br />if Success, Response APDU contains
///                     <c>YubiKey Authentication Response</c>
///                 </description>
///             </item>
///             <item>
///                 <term>
    ...
    InitializeAuthenticateManagementKeyCommand : IYubiKeyCommand<InitializeAuthenticateManagementKeyResponse>
{
    ...
    #region IYubiKeyCommand<InitializeAuthenticateManagementKeyResponse> Members
