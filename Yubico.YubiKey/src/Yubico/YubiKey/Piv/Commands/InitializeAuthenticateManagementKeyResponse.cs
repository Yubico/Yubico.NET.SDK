                                                                  ...
                                                                  ReadOnlyMemory<byte> clientAuthenticationChallenge)>
{
        ...
        : base(responseApdu)
    {
        ...
        _clientAuthenticationChallenge = value[..dataLength].ToArray();
    }
    ...
    #region IYubiKeyResponseWithData<(bool isMutualAuth, ReadOnlyMemory<byte> clientAuthenticationChallenge)> Members
