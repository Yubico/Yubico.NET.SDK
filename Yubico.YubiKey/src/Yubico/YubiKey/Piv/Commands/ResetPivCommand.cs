...
/// </code>
///     <para>
///         This command does not work with YubiKey Bio Multi-protocol Edition (MPE) keys. For MPE keys, use
///         <see cref="Yubico.YubiKey.Management.Commands.DeviceResetCommand" /> instead.
///     </para>
/// </remarks>
public sealed class ResetPivCommand : IYubiKeyCommand<ResetPivResponse>
{
    ...
    #region IYubiKeyCommand<ResetPivResponse> Members
    ...
    /// <inheritdoc />
    public ResetPivResponse CreateResponseForApdu(ResponseApdu responseApdu) => new(responseApdu);
