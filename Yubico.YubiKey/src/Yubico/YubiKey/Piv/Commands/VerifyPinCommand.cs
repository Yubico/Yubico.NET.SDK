...
public sealed class VerifyPinCommand : IYubiKeyCommand<VerifyPinResponse>
{
    ...
    {
        if (!PivPinUtilities.IsValidPinLength(pin.Length))
        {
    ...
    #region IYubiKeyCommand<VerifyPinResponse> Members
    ...
    /// <inheritdoc />
    public VerifyPinResponse CreateResponseForApdu(ResponseApdu responseApdu) => new(responseApdu);
