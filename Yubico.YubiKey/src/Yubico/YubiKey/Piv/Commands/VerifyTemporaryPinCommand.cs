...
public sealed class VerifyTemporaryPinCommand : IYubiKeyCommand<VerifyTemporaryPinResponse>
{
    ...
    #region IYubiKeyCommand<VerifyTemporaryPinResponse> Members
    ...
    /// <inheritdoc />
    public VerifyTemporaryPinResponse CreateResponseForApdu(ResponseApdu responseApdu) => new(responseApdu);
