...
public sealed class VerifyUvCommand : IYubiKeyCommand<VerifyUvResponse>
{
    ...
    #region IYubiKeyCommand<VerifyUvResponse> Members
    ...
    /// <inheritdoc />
    public VerifyUvResponse CreateResponseForApdu(ResponseApdu responseApdu) => new(responseApdu, RequestTemporaryPin);
