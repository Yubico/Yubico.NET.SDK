...
namespace Yubico.YubiKey.Piv
{
    ...
    /// </remarks>
    public sealed class PivCurve25519PrivateKey : PivPrivateKey
    {
        ...
        // used.
        private PivCurve25519PrivateKey()
        {
        ...
        /// </exception>
        public PivCurve25519PrivateKey(ReadOnlySpan<byte> privateValue)
        {
        ...
        /// </param>
        public PivCurve25519PrivateKey(ReadOnlySpan<byte> privateValue, PivAlgorithm algorithm)
        {
        ...
        /// </param>
        /// <returns>
        /// A new instance of a PivCurve25519PrivateKey object based on the encoding.
        /// </returns>
        /// <exception cref="ArgumentException">
        /// The encoding of the private key is not supported.
        /// </exception>
        public static PivCurve25519PrivateKey CreateEccPrivateKey(ReadOnlyMemory<byte> encodedPrivateKey)
        {
            if (TlvObject.TryParse(encodedPrivateKey.Span, out var tlv) && IsValidEccTag(tlv.Tag))
            {
                return tlv.Tag switch
                {
                    EccEd25519Tag => new PivCurve25519PrivateKey(tlv.Value.Span, PivAlgorithm.EccEd25519),
                    EccX25519Tag => new PivCurve25519PrivateKey(tlv.Value.Span, PivAlgorithm.EccX25519),
                    _ => throw new ArgumentException(
                        string.Format(
                            CultureInfo.CurrentCulture,
                            ExceptionMessages.InvalidPrivateKeyData))
        ...
        public static PivPrivateKey CreateFromPrivateKey(IPrivateKeyParameters keyParameters)
        {
            ...
            return new PivCurve25519PrivateKey(privateValue.ToArray(), algorithm, keyDefinition, pivEncodedKey, keyParameters);
        }
    }
}
