...
namespace Yubico.YubiKey.Piv
{
    ...
    internal static class PivPinUtilities
    {
        ...
        /// </returns>
        public static bool HasRetryCount(short statusWord) =>
            (statusWord & StatusWordWrongPinMask) == StatusWordWrongPin;
        ...
        {
            if (IsValidPinLength(pin.Length) == false)
            {
        ...
        public static byte[] CopyTwoPinsWithPadding(ReadOnlyMemory<byte> firstPin, ReadOnlyMemory<byte> secondPin)
        {
            ...
            secondPin.CopyTo(pinMemory.Slice(MaximumPinLength));
