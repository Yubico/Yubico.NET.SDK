...
public sealed partial class PivSession : IDisposable
{
    ...
    /// <summary>
    ///     Try to change the management key. The default management key algorithm will be used. (Firmware 5.7.x and later:
    ///     AES-192. Firmware 5.6.x and earlier: TDES.)
    /// </summary>
    /// <remarks>
    ...
    ///     The default management key algorithm will be used. (Firmware 5.7.x and later: AES-192. Firmware 5.6.x and earlier:
    ///     TDES.)
    /// </summary>
    /// <remarks>
    ...
    private bool TryForcedChangeManagementKey(
        ...
        PivAlgorithm newKeyAlgorithm)
    {
        if (TryAuthenticateManagementKey(currentKey))
        {
