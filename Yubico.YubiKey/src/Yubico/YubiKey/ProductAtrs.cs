...
namespace Yubico.YubiKey
{
    public static class ProductAtrs
    {
        ...
        public static readonly AnswerToReset YubiKeyNeoUsb =
            new AnswerToReset(
                new byte[] {
                    ...
                    0x15, 0x59, 0x75, 0x62, 0x69, 0x6B, 0x65, 0x79,
        ...
        public static readonly AnswerToReset YubiKeyNeoNfc =
            new AnswerToReset(
                new byte[] {
                    0x3B, 0x8C, 0x80, 0x01, 0x59, 0x75, 0x62, 0x69,
                    0x6B, 0x65, 0x79, 0x4E, 0x45, 0x4F, 0x72, 0x33,
                    0x58
                }
            );
        ...
        public static readonly AnswerToReset YubiKey5Nfc =
            new AnswerToReset(
                new byte[] {
                    0x3B, 0x8D, 0x80, 0x01, 0x80, 0x73, 0xC0, 0x21,
                    0xC0, 0x57, 0x59, 0x75, 0x62, 0x69, 0x4B, 0x65,
                    0x79, 0xF9
                }
            );
        ...
        public static IList<AnswerToReset> NfcYubiKeys => new List<AnswerToReset>()
        {
            YubiKeyNeoNfc,
            YubiKey5Nfc,
        };
