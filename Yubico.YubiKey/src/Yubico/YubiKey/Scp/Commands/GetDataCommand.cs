...
///     <para>
///         For getting data in the Security Domain, it is recommended to use the methods provided by
///         <see cref="SecurityDomainSession" /> instead, such as
///         <see cref="SecurityDomainSession.GetData" />, <see cref="SecurityDomainSession.GetCertificates" />,
///         <see cref="SecurityDomainSession.GetSupportedCaIdentifiers" />, and
///         <see cref="SecurityDomainSession.GetKeyInformation" />.
///     </para>
/// </summary>
/// <remarks>
///     <para>
...
internal class GetDataCommand : IYubiKeyCommand<GetDataCommandResponse>
{
    ...
    /// <remarks>
    ///     <para>
    ///         For getting data in the Security Domain,
    ...
    #region IYubiKeyCommand<GetDataCommandResponse> Members
    ...
    public GetDataCommandResponse CreateResponseForApdu(ResponseApdu responseApdu) => new(responseApdu);
