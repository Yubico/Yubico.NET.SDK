...
internal class PerformSecurityOperationCommand : IYubiKeyCommand<SecurityOperationResponse>
{
    ...
    /// <remarks>
    ///     This command is used as part of the SCP11 protocol suite for presenting the off-card entity's certificate chain to
    ///     the YubiKey.
    /// </remarks>
    ...
    #region IYubiKeyCommand<SecurityOperationResponse> Members
    ...
    public SecurityOperationResponse CreateResponseForApdu(ResponseApdu responseApdu) => new(responseApdu);
