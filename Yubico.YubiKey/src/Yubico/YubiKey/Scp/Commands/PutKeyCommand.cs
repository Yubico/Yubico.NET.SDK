...
///             <list type="bullet">
///                 <item>
///                     <description>Sets of three 16-byte keys (ENC, MAC, DEK) for secure channel operations</description>
///                 </item>
///                 <item>
///                     <description>Identified by a Key Version Number (KVN)</description>
///                 </item>
///                 <item>
///                     <description>Keys are encrypted before transmission</description>
///                 </item>
///             </list>
///         </item>
///         <item>
...
///             <list type="bullet">
///                 <item>
///                     <description>NIST P-256 (secp256r1) private keys</description>
///                 </item>
///                 <item>
///                     <description>Identified by a Key Reference (version number and ID)</description>
///                 </item>
///                 <item>
///                     <description>Key data is encrypted using the session's data encryption key</description>
///                 </item>
///                 <item>
///                     <description>Includes checksum verification for integrity</description>
///                 </item>
///             </list>
///         </item>
///         <item>
...
///             <list type="bullet">
///                 <item>
///                     <description>NIST P-256 (secp256r1) public keys</description>
///                 </item>
///                 <item>
///                     <description>Includes EC parameters and key data</description>
///                 </item>
///                 <item>
///                     <description>Includes checksum verification for integrity</description>
///                 </item>
...
internal class PutKeyCommand : IYubiKeyCommand<PutKeyResponse>
{
    ...
    /// <summary>
    ///     This is used internally by the <see cref="SecurityDomainSession" />. Clients should not have to build this
    ///     manually.
    /// </summary>
    ...
    #region IYubiKeyCommand<PutKeyResponse> Members
    ...
    public PutKeyResponse CreateResponseForApdu(ResponseApdu responseApdu) => new(responseApdu);
