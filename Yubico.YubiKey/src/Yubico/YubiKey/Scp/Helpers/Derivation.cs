...
internal static class Derivation
{
    ...
    /// </summary>
    /// <param name="dataDerivationConstant">
    ///     The derivation constant indicating the type of key being derived (e.g., SENC,
    ///     SMAC).
    /// </param>
    ...
    /// </summary>
    /// <param name="dataDerivationConstant">
    ///     The derivation constant (<see cref="DDC_CARD_CRYPTOGRAM" /> or
    ///     <see cref="DDC_HOST_CRYPTOGRAM" />.
    /// </param>
