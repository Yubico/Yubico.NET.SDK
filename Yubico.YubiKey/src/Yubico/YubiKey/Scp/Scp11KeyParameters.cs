...
public sealed class Scp11KeyParameters : ScpKeyParameters, IDisposable
{
    ...
    /// <param name="pkSdEcka">
    ///     The public key of the security domain which is used for key agreement between the off-card
    ///     entity (OCE) and Yubikey.
    /// </param>
    ...
    /// <param name="keyReference">The key reference associated with the key parameters.</param>
    /// <param name="pkSdEcka">
    ///     The public key of the security domain (pkSdEcka) which is used for key agreement between the
    ///     off-card entity (OCE) and Yubikey.
    /// </param>
    /// <param name="oceKeyReference">The off-card entity (OCE) key reference.</param>
    /// <param name="skOceEcka">
    ///     The secret key (skOceEcka) of the off-card entity (OCE) used for key agreement between the
    ///     off-card entity (OCE) and Yubikey.
    /// </param>
    ...
    /// <summary>
    ///     The secret key of the off-card entity (OCE) which is used for key agreement between the off-card entity and the
    ///     YubiKey (SCP11a/c).
