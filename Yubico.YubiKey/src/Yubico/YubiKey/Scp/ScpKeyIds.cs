...
/// </summary>
/// <remarks>
///     See the GlobalPlatform Technology Card Specification v2.3 Amendment F §5.1 Cryptographic Keys for more
///     information on the available KIDs.
/// </remarks>
public static class ScpKeyIds
{
    ...
    ///     <remarks>
    ///         When storing SCP03 keysets, the SDK
    ...
    /// <summary>
    ///     Key ID '0x10' for the public key of the certificate authority, also known as 'PK.CA-KLOC.ECDSA'. Needs to be an
    ///     ECDSA key.
    /// </summary>
