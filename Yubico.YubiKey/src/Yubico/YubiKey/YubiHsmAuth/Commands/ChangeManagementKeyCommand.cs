...
public sealed class ChangeManagementKeyCommand : IYubiKeyCommand<ChangeManagementKeyResponse>
{
    ...
    #region IYubiKeyCommand<ChangeManagementKeyResponse> Members
    ...
    /// <inheritdoc />
    public ChangeManagementKeyResponse CreateResponseForApdu(ResponseApdu responseApdu) => new(responseApdu);
