...
///         <a
///             href="https://developers.yubico.com/yubihsm-shell/API_Documentation/yubihsm_8h.html#a296b43eadb1151017ba8e9578b351c5e">
...
public sealed class GetAes128SessionKeysCommand : IYubiKeyCommand<GetAes128SessionKeysResponse>
{
    ...
    /// </param>
    public GetAes128SessionKeysCommand(
    ...
    #region IYubiKeyCommand<GetAes128SessionKeysResponse> Members
    ...
    /// <inheritdoc />
    public GetAes128SessionKeysResponse CreateResponseForApdu(ResponseApdu responseApdu) => new(responseApdu);
