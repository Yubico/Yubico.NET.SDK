...
namespace Yubico.YubiKey.YubiHsmAuth.Commands
{
    ...
    /// a secure connection with a YubiHSM 2 device using ECC P-256 credentials.
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// <para>
    /// The associated command class is <see cref="GetEccP256SessionKeysCommand"/>.
    /// </para>
    /// </remarks>
        ...
        IYubiKeyResponseWithData<SessionKeys>
    {
        ...
        /// </param>
        public GetEccP256SessionKeysResponse(ResponseApdu responseApdu) :
            base(responseApdu)
        {
        }
