...
{
    /// <summary>
    /// The command class for calculating session keys from an ECC P-384
    ...
    /// procedure. See <see cref="GetEccP384SessionKeysResponse"/> for more
    ...
    /// <see cref="GetEccP384SessionKeysResponse"/>.
    /// </para>
    /// </remarks>
    public sealed class GetEccP384SessionKeysCommand : IYubiKeyCommand<GetEccP384SessionKeysResponse>
    {
        ...
        /// </param>
        public GetEccP384SessionKeysCommand(string credentialLabel,
        ...
        /// <inheritdoc/>
        public GetEccP384SessionKeysResponse CreateResponseForApdu(ResponseApdu responseApdu) =>
            new GetEccP384SessionKeysResponse(responseApdu);
