...
namespace Yubico.YubiKey.YubiHsmAuth.Commands
{
    ...
    /// a secure connection with a YubiHSM 2 device using ECC P-384 credentials.
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// <para>
    /// The associated command class is <see cref="GetEccP384SessionKeysCommand"/>.
    /// </para>
    /// </remarks>
    public class GetEccP384SessionKeysResponse : BaseYubiHsmAuthResponseWithRetries,
        IYubiKeyResponseWithData<SessionKeys>
    {
        ...
        /// <summary>
        /// Constructs a GetEccP384SessionKeysResponse based on a ResponseApdu
        /// received from the YubiKey.
        /// </summary>
        /// <param name="responseApdu">
        /// The ResponseApdu returned by the YubiKey.
        /// </param>
        public GetEccP384SessionKeysResponse(ResponseApdu responseApdu) :
            base(responseApdu)
        {
        }
