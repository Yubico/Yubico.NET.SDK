...
{
    /// <summary>
    /// This class is used when adding a new credential with an ECC P-256
    ...
    public class EccP256CredentialWithSecrets : CredentialWithSecrets
    {
        ...
        /// <summary>
        /// The ECC P-256 private key. Its length must be equal to
        ...
        /// <summary>
        /// Create an ECC P-256 credential to be stored in the YubiHSM Auth
        /// application.
        /// </summary>
        ...
        /// </param>
        /// <exception cref="ArgumentException">
        /// Thrown when the ECC P-256 private key does not have the required size (see
        /// <see cref="RequiredKeySize"/>).
        /// </exception>
        public EccP256CredentialWithSecrets(
            ReadOnlyMemory<byte> credentialPassword,
            ReadOnlyMemory<byte> privateKey,
            string label,
            bool touchRequired)
            : base(credentialPassword, CryptographicKeyType.SecP256R1, label, touchRequired)
        {
