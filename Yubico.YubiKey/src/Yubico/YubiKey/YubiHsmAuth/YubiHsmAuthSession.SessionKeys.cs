...
namespace Yubico.YubiKey.YubiHsmAuth
{
    ...
    public partial class YubiHsmAuthSession
    {
        ...
        /// <para>
        /// Some steps must be performed prior to calling this command. First,
        /// retrieve a host challenge (65 bytes) from the YubiKey device, and
        /// retrieve the HSM device challenge (65 bytes) from the YubiHSM 2 device.
        ...
        /// </param>
        /// <param name="hostChallenge">
        /// The 65 byte host challenge generated by the YubiKey device.
        /// </param>
        /// <param name="hsmDeviceChallenge">
        /// The 65 byte challenge generated by the YubiHSM 2 device.
        /// </param>
        /// <param name="publicKey">
        /// The device's public key for asymmetric authentication (65 bytes for P-256).
        /// </param>
        /// <param name="cardCrypto">
        /// The device's cryptographic response for asymmetric authentication.
        /// </param>
        /// <exception cref="InvalidOperationException">
        /// The credential could not be found.
        /// </exception>
        ...
        /// The operation timed out waiting for touch.
        /// </exception>
        public Ecp256SessionKeys GetEccP256SessionKeys(string credentialLabel,
                                                ReadOnlyMemory<byte> credentialPassword,
                                                ReadOnlyMemory<byte> hostChallenge,
                                                ReadOnlyMemory<byte> hsmDeviceChallenge, 
        ...
        public bool TryGetEccP256SessionKeys(string credentialLabel,
                                            ...
                                            ReadOnlyMemory<byte> publicKey,
                                            ReadOnlyMemory<byte> cardCrypto,
                                            [NotNullWhen(true)] out Ecp256SessionKeys? sessionKeys)
        {
            sessionKeys = null;
