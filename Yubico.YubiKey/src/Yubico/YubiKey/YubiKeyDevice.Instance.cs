...
public partial class YubiKeyDevice : IYubiKeyDevice
{
    ...
    internal bool HasSmartCard => _smartCardDevice is not null;
    internal bool HasHidFido => _hidFidoDevice is not null;
    internal bool HasHidKeyboard => _hidKeyboardDevice is not null;
    ...
    {
        if (obj is not IYubiKeyDevice other)
        {
            return false;
        }
    ...
    public int CompareTo(IYubiKeyDevice other)
    {
        ...
        if (SerialNumber == null && other.SerialNumber == null)
        {
            if (other is not YubiKeyDevice concreteKey)
            {
                return 1;
            }
