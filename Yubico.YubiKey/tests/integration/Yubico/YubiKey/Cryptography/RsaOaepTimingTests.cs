...
public class RsaOaepTimingTests
{
    ...
    [InlineData(2048, RsaFormat.Sha512, 32)]
    [InlineData(2048, RsaFormat.Sha512, 48)]
    public void FirstByteWrong_Time(
        int keySizeBits,
        int digestFlag,
        int dataLength)
    {
        ...
        var totalTime = RunTimerOaep(formattedData, digestFlag, 0, out var isValid);
        ...
        int dataLength)
    {
        var dataToPad = new byte[dataLength];
        _random.GetBytes(dataToPad);
        var formattedData = FormatOaepWrong(dataToPad, digestFlag, keySizeBits, 1);
    ...
    [InlineData(2048, RsaFormat.Sha512, 32)]
    [InlineData(2048, RsaFormat.Sha512, 48)]
    public void SeparatorWrong_Time(
        int keySizeBits,
        int digestFlag,
        int dataLength)
    {
        var dataToPad = new byte[dataLength];
        _random.GetBytes(dataToPad);
        var formattedData = FormatOaepWrong(dataToPad, digestFlag, keySizeBits, 2);
        ...
        int dataLength)
    {
        var dataToPad = new byte[dataLength];
        _random.GetBytes(dataToPad);
        var formattedData = FormatOaepWrong(dataToPad, digestFlag, keySizeBits, 4);
        ...
        int dataLength)
    {
        var dataToPad = new byte[dataLength];
        _random.GetBytes(dataToPad);
        var formattedData = FormatOaepWrong(dataToPad, digestFlag, keySizeBits, 3);
        formattedData[0] = 2;
    ...
    private static long RunTimerOaep(
        byte[] formattedData,
        int digestFlag,
        int expectedLength,
        out bool isValid)
    ...
    private static byte[] GetKeySizeBuffer(
        int keySizeBits)
    {
