...
public class RsaP1TimingTests
{
        ...
        int keySizeBits)
    {
        ...
        for (var index = 0; index < dataLength.Length; index++)
        {
            ...
            var totalTime = RunTimerP15(formattedData, 0, out isValid);
    ...
    [InlineData(1024)]
    [InlineData(2048)]
    public void SecondByteWrong_Time(
        int keySizeBits)
    {
        var isValid = false;
        int[] dataLength = { 16, 24, 32, 48 };
    ...
    [InlineData(1024)]
    [InlineData(2048)]
    public void MultipleErrors_Time(
        int keySizeBits)
    {
        var isValid = false;
        int[] dataLength = { 16, 24, 32, 48 };
        ...
        int keySizeBits)
    {
        ...
        var totalTime = RunTimerP15(formattedData, 0, out var isValid);
    ...
    private static long RunTimerP15(
        byte[] formattedData,
        int expectedLength,
        out bool isValid)
    {
