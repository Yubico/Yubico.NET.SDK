...
public class BioEnrollTests : SimpleIntegrationTestConnection
{
    ...
    public void EnrollFingerprint_Succeeds()
    {
        ...
        using (var fido2Session = new Fido2Session(Device))
        {
            ...
            var templateInfo = fido2Session.EnrollFingerprint(firstName, 5000);
    ...
    [InlineData(4)]
    [InlineData(-1)]
    public void EnrollFingerprint_Cancel_ThrowsCorrect(
        int cancelCount)
    {
        ...
        KeyEntryData arg)
    {
        ...
        if (_callCancelCount > 0 && arg.LastBioEnrollSampleResult is not null)
        {
        ...
        switch (arg.Request)
        {
            ...
            case KeyEntryRequest.VerifyFido2Uv:
                if (callCancel && arg.SignalUserCancel is not null)
                {
