...
namespace Yubico.YubiKey.Fido2.Commands
{
    ...
    public class BioEnrollmentCommandTests : NeedPinToken
    {
        ...
        public void GetModalityCommand_Succeeds()
        {
            ...
            Assert.Equal(expected: 1, modality);
        }
        ...
        public void BioEnrollBegin_Succeeds()
        {
            ...
            var cmd = new BioEnrollBeginCommand(timeoutMilliseconds: 5000, pinToken, protocol);
            var rsp = Connection.SendCommand(cmd);
        ...
        public void BioEnrollNextSample_Succeeds()
        {
            ...
            var cmd = new BioEnrollBeginCommand(timeoutMilliseconds: null, pinToken, protocol);
            var rsp = Connection.SendCommand(cmd);
            var enrollResult = rsp.GetData();
            Assert.Equal(BioEnrollSampleStatus.FpGood, enrollResult.LastEnrollSampleStatus);

            var nextCmd = new BioEnrollNextSampleCommand(enrollResult.TemplateId, timeoutMilliseconds: null, pinToken,
                protocol);
            var totalCount = 1;
            do
            {
            ...
            Assert.Equal(expected: 0, enrollResult.RemainingSampleCount);
        }
        ...
        public void FriendlyNameCommand_Succeeds()
        {
            ...
            var nameCmd = new BioEnrollSetFriendlyNameCommand(
                templateInfos[index: 0].TemplateId, "NameTwo", pinToken, protocol);
        ...
        public void DeleteCommand_Succeeds()
        {
            ...
            var removeCmd = new BioEnrollRemoveCommand(
                templateInfos[index: 0].TemplateId, pinToken, protocol);
