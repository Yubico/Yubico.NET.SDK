...
public class HmacSecretTests : SimpleIntegrationTestConnection
{
    ...
    {
        makeParams = new MakeCredentialParameters(FidoSessionIntegrationTestBase.Rp,
            FidoSessionIntegrationTestBase.UserEntity);
        ...
        var pinUvAuthParam =
            _protocol.AuthenticateUsingPinToken(pinToken, FidoSessionIntegrationTestBase.ClientDataHash);
    ...
    {
        assertionParams = new GetAssertionParameters(FidoSessionIntegrationTestBase.Rp,
            FidoSessionIntegrationTestBase.ClientDataHash);
        ...
        out byte[] pinToken)
    {
        ...
        do
        {
            var getTokenCmd = new GetPinUvAuthTokenUsingPinCommand(_protocol, FidoSessionIntegrationTestBase.TestPin1,
                permissions, rpId);
