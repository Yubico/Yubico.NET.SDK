...
public class LargeBlobTests
{
    ...
    private static readonly RelyingParty _rp = new("relyingparty1");
    ...
    {
        _testDevice = IntegrationTestDeviceEnumeration.GetTestDevice();
    }
    ...
    public void SetLargeBlob_Succeeds()
    {
        using (var fido2Session = new Fido2Session(_testDevice))
        {
            ...
            if (mcData1.LargeBlobKey is not null)
            {
            ...
            if (mcData2.LargeBlobKey is not null)
            {
            ...
            var isDecrypted = blobArray.Entries[0].TryDecrypt(key1, out var plaintext1);
