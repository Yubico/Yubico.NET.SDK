...
public class MakeCredentialBlobTests
{
    ...
    public void CredBlobExtension_Correct()
    {
        ...
        Assert.Equal(32,
            authInfo.MaximumCredentialBlobLength); /* Assert.Equal() Failure: Values differExpected: 32 Actual: null */
    ...
    public void MakeCredentialCommand_Succeeds()
    {
        ...
        var isValid = fido2Session.TryVerifyPin(FidoSessionIntegrationTestBase.TestPin1, null, null,
