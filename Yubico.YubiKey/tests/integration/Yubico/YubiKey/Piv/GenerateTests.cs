...
namespace Yubico.YubiKey.Piv
{
    ...
    public class GenerateTests
    {
        ...
        public void GenerateAndSign(PivAlgorithm algorithm)
        {
            ...
            var isValid = DoGenerate(testDevice, slotNumber: 0x86, algorithm, PivPinPolicy.Once, PivTouchPolicy.Never);
            Assert.True(isValid);

            isValid = DoSignNoPin(testDevice, slotNumber: 0x86, algorithm);
            Assert.False(isValid);

            isValid = DoSignWithPin(testDevice, slotNumber: 0x86, algorithm);
            Assert.True(isValid);
        }
        ...
        private static byte[] GetDigestData(PivAlgorithm algorithm)
        {
