...
public class ManagementKeyTests : PivSessionIntegrationTestBase
{
    ...
    [InlineData(StandardTestDevice.Fw5)]
    [InlineData(StandardTestDevice.Fw5Fips)]
    public void ChangeManagementKey_WithDefaultParameters_UsesCorrectTypeForRespectiveVersion(
        StandardTestDevice device)
    {
    ...
    private bool TestKeyCollectorDelegate(
