...
public class X500NameBuilder
{
    ...
    public void AddNameElement(
        X500NameElement nameElement,
        string value)
    {
...
public static class X500NameElementExtensions
{
    ...
    public static byte[] GetDerEncoding(
        this X500NameElement nameElement,
        string value)
    {
    ...
    public static bool IsValidValueLength(
        this X500NameElement nameElement,
        int length)
    {
        return nameElement switch
