...
{
    private readonly ReadOnlyMemory<byte> _firstPin = new(new byte[]
    {
        0x31, 0x32, 0x33, 0x34, 0x35, 0x36
    });

    private readonly ReadOnlyMemory<byte> _secondPin = new(new byte[]
    {
    ...
    public bool SimpleU2fKeyCollectorDelegate(
