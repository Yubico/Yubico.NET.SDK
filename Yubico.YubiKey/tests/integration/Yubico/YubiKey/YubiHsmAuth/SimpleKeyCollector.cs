...
public class SimpleKeyCollector
{
    ...
    ///     "alternate" set.
    /// </summary>
    public bool FlipFlopCollectorDelegate(
    ...
    /// </summary>
    public static bool DefaultValueCollectorDelegate(
        KeyEntryData keyEntryData)
    {
    ...
    /// </summary>
    public static bool AlternateValueCollectorDelegate(
        KeyEntryData keyEntryData)
    {
        if (keyEntryData is null)
        {
    ...
    /// </summary>
    public static bool ReturnsFalseCollectorDelegate(
        KeyEntryData _)
    {
        return false;
    }
