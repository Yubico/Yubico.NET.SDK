...
public class YubiKeyDeviceTests
{
    ...
    private bool TryGetSkyDevice(
        out IYubiKeyDevice skyDevice)
    {
        ...
        StandardTestDevice testDeviceType)
    {
        ...
        // Test
        _ = Assert.Throws<InvalidOperationException>(() => testDevice.LockConfiguration(TestLockCode));
    }
        ...
        StandardTestDevice testDeviceType)
    {
        ...
        // Test
        _ = Assert.Throws<InvalidOperationException>(() => testDevice.UnlockConfiguration(LockCodeAllZero));
    }
        ...
        StandardTestDevice testDeviceType)
    {
        ...
        _ = Assert.Throws<InvalidOperationException>(() => testDevice.UnlockConfiguration(TestLockCode));
    }
    ...
    private static IYubiKeyDevice ResetDeviceInfo(
