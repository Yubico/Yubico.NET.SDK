...
public class AsnPublicKeyEncoderTests
{
    ...
    public void RsaKeyRoundtrip_With_ModulusAndExponent_ShouldMatchOriginal(
        KeyType keyType)
    {
        // Arrange
    ...
    public void Curve25519_InvalidKeySizes_ShouldThrow(
        int keySize)
    {
        // Arrange
        ...
        Assert.Throws<ArgumentException>(() =>
            AsnPublicKeyEncoder.EncodeToSubjectPublicKeyInfo(invalidKey, KeyType.Ed25519));
        Assert.Throws<ArgumentException>(() =>
            AsnPublicKeyEncoder.EncodeToSubjectPublicKeyInfo(invalidKey, KeyType.Ed25519));
    }
    ...
    [InlineData(KeyType.ECP384)]
    [InlineData(KeyType.ECP521)]
    public void FromPublicPointAndKeyType_ECKeys_ShouldCreateValidEncoding(
        KeyType keyType)
    {
        // Arrange
        using var ecdsa = keyType switch
    ...
    [InlineData(KeyType.ECP384)]
    [InlineData(KeyType.ECP521)]
    public void FromECParameters_ShouldCreateValidEncoding(
        KeyType keyType)
    {
        // Arrange
        using var ecdsa = keyType switch
    ...
    [InlineData(KeyType.ECP384)]
    [InlineData(KeyType.ECP521)]
    public void FromECParameters_WithTestKeys_ShouldCreateValidEncoding(
        KeyType keyType)
    {
        // Arrange
