...
public class ECPublicKeyTests
{
    ...
    public void CreateECDsaFromPkcs8EncodedKey_WithValidKey_CreatesInstance(
        KeyType keyType)
    {
        // Arrange
        ...
        var ecPublicKeyParams = publicKeyParams;
    ...
    public void CreateFromValue_WithInvalidParameters_CreatesInstance(
        KeyType keyType)
    {
        // Arrange
        var testPublicKey = TestKeys.GetTestPublicKey(keyType);
    ...
    public void PublicPoint_ReturnsCorrectFormat()
    {
        ...
        Assert.NotNull(publicKeyParams.Parameters.Q.X);
        Assert.NotNull(publicKeyParams.Parameters.Q.Y);
        Assert.Equal(1 + publicKeyParams.Parameters.Q.X.Length + publicKeyParams.Parameters.Q.Y.Length,
            publicPoint.Length);
