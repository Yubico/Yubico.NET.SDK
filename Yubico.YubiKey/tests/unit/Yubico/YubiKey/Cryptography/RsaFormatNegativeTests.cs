...
public class RsaFormatNegativeTests
{
    ...
    [InlineData(3, 1025)]
    [InlineData(3, 2049)]
    public void Format_WrongKeySize_Exception(
        int format,
        int keySize)
    {
        var digest = new byte[]
    ...
    [InlineData(4, 130)]
    [InlineData(4, 254)]
    public void Parse_WrongInputSize_Exception(
        int format,
        int bufferSize)
    {
        ...
        var digest = new Span<byte>(buffer).Slice(4, 20);
...
#pragma warning restore IDE0018 // Inline variable declaration
    ...
    public void Format_WrongDigestAlg_Exception(
        int format,
        int digestAlgorithm,
        int keySize)
    {
    ...
    public void Parse_WrongDigest_Exception(
        int format,
        int digestAlgorithm,
        int bufferSize)
    {
...
#pragma warning restore IDE0018 // Inline variable declaration
    ...
    public void FormatP1Sign_WrongDigestLength_Exception(
        int digestAlgorithm,
        int keySize)
    {
        var digest = new byte[]
    ...
    public void ParseP1Sign_WrongMarkerBytes_ReturnFalse(
        byte leadByte,
        byte algByte,
        byte separator)
    {
        var formattedData = new byte[]
        {
    ...
    public void ParseP1Sign_WrongDigestInfo_ReturnFalse(
        byte oidByte,
        bool nullParams)
    {
        var formattedData = new byte[]
    ...
    public void ParsePss_WrongDigest_IsVerifiedFalse()
    {
        ...
        digest[^1] = 0x21;
        var isValid = RsaFormat.TryParsePkcs1Pss(formattedData, digest, RsaFormat.Sha256, out _, out var isVerified);
    ...
    [InlineData(1024)]
    [InlineData(2048)]
    public void Format_P15Encrypt_TooMuchData_Exception(
        int keySize)
    {
        var dataLength = 118;
        if (keySize == 2048)
    ...
    public void ParseP1Decrypt_WrongMarkerBytes_ReturnFalse(
        byte leadByte,
        byte algByte)
    {
        var formattedData = new byte[]
