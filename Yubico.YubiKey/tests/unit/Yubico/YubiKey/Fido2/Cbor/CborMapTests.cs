...
public class CborMapTests
{
    ...
    private static bool ReadUsingCborMap(
        byte[] encoding)
    {
    ...
    private static bool ReadUsingCborReader(
        byte[] encoding)
    {
    ...
    private static bool ReadArrayX3(
        CborReader cbor)
    {
