...
public class CredMgmtDataTests
{
    ...
    public void CredMgm_Decode_CorrectNumCredentials()
    {
        ...
        if (mgmtData.NumberOfDiscoverableCredentials is not null && expected is int unboxedValue)
        {
    ...
    public void CredMgm_Decode_CorrectRemainCount()
    {
        ...
        if (mgmtData.RemainingCredentialCount is not null && expected is int unboxedValue)
        {
    ...
    public void CredMgm_Decode_CorrectRpId()
    {
        ...
        if (mgmtData.RelyingParty is not null && expected is string unboxedValue)
        {
    ...
    public void CredMgm_Decode_CorrectRpIdHash()
    {
        ...
        if (mgmtData.RelyingPartyIdHash is not null && expected is byte[] unboxedValue)
        {
    ...
    public void CredMgm_Decode_CorrectRpCount()
    {
        ...
        if (mgmtData.TotalRelyingPartyCount is not null && expected is int unboxedValue)
        {
    ...
    public void CredMgm_Decode_CorrectUserId()
    {
        ...
        if (mgmtData.User is not null && expected is byte[] unboxedValue)
        {
    ...
    public void CredMgm_Decode_CorrectUserName()
    {
        ...
        if (mgmtData.User is not null && expected is string unboxedValue)
        {
    ...
    public void CredMgm_Decode_CorrectCredIdId()
    {
        ...
        if (mgmtData.CredentialId is not null && expected is byte[] unboxedValue)
        {
    ...
    public void CredMgm_Decode_CorrectCredIdType()
    {
        ...
        if (mgmtData.CredentialId is not null && expected is string unboxedValue)
        {
    ...
    public void CredMgm_Decode_CorrectCredIdTransports()
    {
        ...
        if (mgmtData.CredentialId is not null && expected is string[] unboxedValue)
        {
            if (mgmtData.CredentialId.Transports is not null &&
    ...
    public void CredMgm_Decode_CorrectKeyType()
    {
        ...
        if (mgmtData.CredentialPublicKey is not null && expected is CoseKeyType unboxedValue)
        {
    ...
    public void CredMgm_Decode_CorrectKeyAlg()
    {
        ...
        if (mgmtData.CredentialPublicKey is not null && expected is CoseAlgorithmIdentifier unboxedValue)
        {
    ...
    public void CredMgm_Decode_CorrectCurve()
    {
        ...
        if (mgmtData.CredentialPublicKey is not null && expected is CoseEcCurve unboxedValue)
        {
    ...
    public void CredMgm_Decode_CorrectX()
    {
        ...
        if (mgmtData.CredentialPublicKey is not null && expected is byte[] unboxedValue)
        {
            if (mgmtData.CredentialPublicKey is CoseEcPublicKey pubKey)
            {
    ...
    public void CredMgm_Decode_CorrectTotalCredentialCount()
    {
        ...
        if (mgmtData.TotalCredentialsForRelyingParty is not null && expected is int unboxedValue)
        {
    ...
    public void CredMgm_Decode_CorrectCredProtectPolicy()
    {
        ...
        if (mgmtData.CredProtectPolicy is not null && expected is int unboxedValue)
        {
    ...
    public void CredMgm_Decode_CorrectLargeBlobKey()
    {
        ...
        if (mgmtData.LargeBlobKey is not null && expected is byte[] unboxedValue)
        {
    ...
    private CredentialManagementData GetFullCredMgmtData(
        out Dictionary<int, object> expectedValues)
    {
        ...
        expectedValues.Add(NumCredentials, 2);
        expectedValues.Add(RemainCount, 23);
