...
namespace Yubico.YubiKey.Fido2
{
    public class Fido2InfoTests
    {
        ...
        public void Decode_Versions_Correct()
        {
            ...
            var encodedData = GetSampleEncoded();

            var fido2Info = new AuthenticatorInfo(encodedData);
            var isValid = CompareStringLists(correctStrings, fido2Info.Versions);
        ...
        public void Decode_Extensions_Correct()
        {
            ...
            var isValid = CompareStringLists(correctStrings, fido2Info.Extensions);
        ...
        {
            var encodedData = GetMinimumEncoded();
        ...
        public void Decode_Aaguid_Correct()
        {
            ...
            var fido2Info = new AuthenticatorInfo(encodedData);
            var isValid = MemoryExtensions.SequenceEqual(correctValue, fido2Info.Aaguid.Span);
        ...
        public void Decode_Options_Correct()
        {
            ...
            if (fido2Info.Options.Count == correctKeys.Length)
            {
                ...
                {
                    if (fido2Info.Options.TryGetValue(correctKeys[index], out var currentValue))
                    {
        ...
        public void Decode_MaxMsgSize_Correct()
        {
            ...
            var fido2Info = new AuthenticatorInfo(encodedData);
            Assert.Equal(expected: 1200, fido2Info.MaximumMessageSize);
        }
        ...
        public void Decode_MaxCredCount_Correct()
        {
            ...
            var fido2Info = new AuthenticatorInfo(encodedData);
            Assert.Equal(expected: 8, fido2Info.MaximumCredentialCountInList);
        }
        ...
        public void Decode_MaxCredIdLength_Correct()
        {
            ...
            var fido2Info = new AuthenticatorInfo(encodedData);
            Assert.Equal(expected: 128, fido2Info.MaximumCredentialIdLength);
        }
        ...
        public void Decode_Transports_Correct()
        {
            ...
            var isValid = CompareStringLists(correctStrings, fido2Info.Transports);
        ...
        public void Decode_Algorithms_Correct()
        {
            ...
            if (fido2Info.Algorithms.Count == correctAlgs.Length)
            {
                ...
                {
                    var currentType = fido2Info.Algorithms[index].Item1;
                    var currentAlg = fido2Info.Algorithms[index].Item2;
        ...
        public void Decode_MaxBlobArraySize_Correct()
        {
            ...
            var fido2Info = new AuthenticatorInfo(encodedData);
            Assert.Equal(expected: 2000, fido2Info.MaximumSerializedLargeBlobArray);
        }
        ...
        public void Decode_MinPinLength_Correct()
        {
            ...
            var fido2Info = new AuthenticatorInfo(encodedData);
            Assert.Equal(expected: 4, fido2Info.MinimumPinLength);
        }
        ...
        public void Decode_FirmwareVersion_Correct()
        {
            ...
            var fido2Info = new AuthenticatorInfo(encodedData);
            Assert.Equal(expected: 0x00050403, fido2Info.FirmwareVersion);
        }
        ...
        public void Decode_MaxCredBlobLength_Correct()
        {
            ...
            var fido2Info = new AuthenticatorInfo(encodedData);
            Assert.Equal(expected: 36, fido2Info.MaximumCredentialBlobLength);
        }
        ...
        public void Decode_MaxRpidLength_Correct()
        {
            ...
            var fido2Info = new AuthenticatorInfo(encodedData);
            Assert.Equal(expected: 8, fido2Info.MaximumRpidsForSetMinPinLength);
        }
        ...
        public void Decode_UvAttempts_Correct()
        {
            ...
            var fido2Info = new AuthenticatorInfo(encodedData);
            Assert.Equal(expected: 1, fido2Info.PreferredPlatformUvAttempts);
        }
        ...
        public void Decode_UvModality_Correct()
        {
            ...
            var fido2Info = new AuthenticatorInfo(encodedData);
            Assert.Equal(expected: 2, fido2Info.UvModality);
        }
        ...
        public void Decode_Certifications_Correct()
        {
            ...
            if (fido2Info.Certifications.Count == correctKeys.Length)
            {
                for (; index < correctKeys.Length; index++)
                {
                    if (fido2Info.Certifications.TryGetValue(correctKeys[index], out var currentValue))
                    {
                        if (currentValue == correctValues[index])
                        {
                            continue;
        ...
        public void Decode_RemainingDiscoverable_Correct()
        {
            ...
            var fido2Info = new AuthenticatorInfo(encodedData);
            Assert.Equal(expected: 2, fido2Info.RemainingDiscoverableCredentials);
        }
        ...
        {
            var correctIds = new[] { 0x4d0619f94a0ee581, 0x0000000080000000 };

            var encodedData = GetSampleEncoded();

            var fido2Info = new AuthenticatorInfo(encodedData);
            var isValid = CompareLongLists(correctIds, fido2Info.VendorPrototypeConfigCommands);
        ...
        {
            var returnedValue = AuthenticatorOptions.GetDefaultOptionValue(option);
        ...
        public void Extensions_IsSupported_Correct(string extension, bool expectedValue)
        {
            ...
            var fido2Info = new AuthenticatorInfo(encodedData);
            var isSupported = fido2Info.IsExtensionSupported(extension);
        ...
        private static bool CompareLongLists(long[] correctInts, IReadOnlyList<long>? candidate)
        {
            ...
            for (var index = 0; index < correctInts.Length; index++)
            {
        ...
        private static bool CompareStringLists(string[] correctStrings, IReadOnlyList<string> candidate)
        {
            ...
            for (var index = 0; index < correctStrings.Length; index++)
            {
        ...
        internal static byte[] GetSampleEncoded()
        {
            ...
            // e.g.) if desired.
            var returnValue = new byte[encodedData.Length];
