...
namespace Yubico.YubiKey.Fido2
{
    public class GetAssertionDataTests
    {
        ...
        public void Verify_Succeeds()
        {
            ...
            byte[] encodedData = GetAssertionResponseEncoding();
        ...
        [Fact]
        public void GetAssertionData_RawData_PreservesOriginalEncoding()
        {
            byte[] encodedData = GetAssertionResponseEncoding();

            using var assertionData = new GetAssertionData(encodedData);
            encodedData[0] = 0xA0;

            Assert.True(MemoryExtensions.SequenceEqual(
                assertionData.RawData.Span,
                GetAssertionResponseEncoding()));
        }

        private static byte[] GetAssertionResponseEncoding() => new byte[] {
