...
namespace Yubico.YubiKey.Fido2
{
    public class LargeBlobArrayTests
    {
        ...
        public void InitialArray_CorrectDigest()
        {
            ...
            {
                var isValid = arrayMem.Slice(start: 1).Span.SequenceEqual(array.Digest.Value.Span);
                Assert.True(isValid);
            }
        }
        ...
        private void EncodeArray_CorrectBlobArray()
        {
            ...
            {
                var isValid =
                    new Span<byte>(expectedEncoding).SequenceEqual(array.EncodedArray.Value.Span);
                Assert.True(isValid);
            }
        }
