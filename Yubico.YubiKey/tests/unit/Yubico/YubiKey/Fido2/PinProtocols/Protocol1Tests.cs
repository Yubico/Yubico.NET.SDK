...
public class Protocol1Tests
{
    ...
    public void Encrypt_Correct()
    {
        ...
        var encryptedData = p1.Encrypt(dataToEncrypt, 0, dataToEncrypt.Length);
        var decryptedData = p1.Decrypt(encryptedData, 0, encryptedData.Length);
    ...
    public void Authenticate_Correct()
    {
        ...
        Assert.Equal(16, authValue.Length);
    }
