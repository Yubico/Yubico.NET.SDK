...
public class PutCredentialCommandTests
{
    ...
    {
        var credential = new Credential("Microsoft", "test@outlook.com", CredentialType.Totp, HashAlgorithm.Sha1, "tt",
            CredentialPeriod.Period30, 6, 0, true);
        var command = new PutCommand { Credential = credential };
        byte[] dataList =
        {
            0x71, 0x1A, 0x4D, 0x69, 0x63, 0x72, 0x6F, 0x73, 0x6F, 0x66,
    ...
    {
        var credential = new Credential("Microsoft", "test@outlook.com", CredentialType.Hotp, HashAlgorithm.Sha1, "tt",
            CredentialPeriod.Undefined, 6, 4, true);
        var command = new PutCommand { Credential = credential };
        byte[] dataList =
        {
            0x71, 0x1A, 0x4D, 0x69, 0x63, 0x72, 0x6F, 0x73, 0x6F, 0x66,
    ...
    {
        var credential = new Credential("Microsoft", "test@outlook.com", CredentialType.Hotp, HashAlgorithm.Sha1, "tt",
            CredentialPeriod.Undefined, 6, 4, false);
        var command = new PutCommand { Credential = credential };
        byte[] dataList =
        {
            0x71, 0x1A, 0x4D, 0x69, 0x63, 0x72, 0x6F, 0x73, 0x6F, 0x66,
