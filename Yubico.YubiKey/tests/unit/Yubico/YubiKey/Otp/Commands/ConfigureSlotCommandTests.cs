...
public class ConfigureSlotCommandTests
{
    ...
    public void SetFixedData_BufferIsTooLong_ThrowsArgumentException()
    {
        ...
        void Action()
        {
            command.SetFixedData(new byte[17]);
        }
    ...
    {
        var expectedFixed = new byte[SlotConfigureBase.FixedDataLength];
        var command = new ConfigureSlotCommand();
    ...
    public void SetUid_BufferIsInvalidLength_ThrowsArgumentException()
    {
        ...
        void Action()
        {
            command.SetUid(Array.Empty<byte>());
        }
    ...
    {
        var expectedUid = Enumerable.Repeat((byte)0xFF, ConfigureSlotCommand.UidLength).ToArray();
        var command = new ConfigureSlotCommand();

        command.SetUid(expectedUid);
        var data = command.CreateCommandApdu().Data;
        var dataSlice = data.Slice(ConfigureSlotCommand.FixedDataLength, ConfigureSlotCommand.UidLength).Span;
    ...
    {
        var expectedAccessCode = Enumerable.Repeat((byte)0xFF, UpdateSlotCommand.AccessCodeLength).ToArray();
        var command = new ConfigureSlotCommand();
    ...
    public void ApplyCurrentAccessCode_ValidBuffer_PlacedCorrectlyInDataBuffer()
    {
        ...
        var data = command.CreateCommandApdu().Data;
        var dataSlice = data.Slice(52, ConfigureSlotCommand.AccessCodeLength).Span;
    ...
    public void CreateCommandApdu_AesKeyOfInvalidLength_ThrowsArgumentException()
    {
        ...
        void Action()
        {
            command.SetAesKey(Array.Empty<byte>());
        }
    ...
    {
        var expectedAesKey = Enumerable.Repeat((byte)0xFF, ConfigureSlotCommand.AesKeyLength).ToArray();
        var command = new ConfigureSlotCommand();
    ...
    {
        var expectedAccessCode = Enumerable.Repeat((byte)0xFF, ConfigureSlotCommand.AccessCodeLength).ToArray();
        var command = new ConfigureSlotCommand();
