...
#pragma warning disable CS8625 // Cannot convert null literal to non-nullable reference type.
        static void action()
        {
            _ = new GetPagedDeviceInfoResponse(null);
        }
#pragma warning restore CS8625 // Cannot convert null literal to non-nullable reference type.
    ...
    [Fact]
    public void GetData_RespectsLengthField_IgnoresJunkAtEndOfBuffer()
    {
        var expectedFormFactor = FormFactor.UsbAKeychain;
    ...
    [Theory]
    [InlineData(new byte[] { 0x00, 0x90, 0x00 })]
    [InlineData(new byte[] { 0x00, 0x01, 0x02, 0x03, 0x90, 0x00 })]
    public void GetData_ZeroTlvData_ThrowsMalformedYkResponse(
        byte[] data)
    {
    ...
    [Theory]
    [InlineData(new byte[] { 0x01, 0x90, 0x00 })]
    [InlineData(new byte[] { 0x0A, 0x01, 0x02, 0x03, 0x90, 0x00 })]
    [InlineData(new byte[] { 0xFF, 0x01, 0x02, 0x03, 0x90, 0x00 })]
    public void GetData_TooLargeLengthField_ThrowsMalformedYkResponse(
        byte[] data)
    {
        var responseApdu = new ResponseApdu(data);
        var getDeviceInfoResponse = new GetPagedDeviceInfoResponse(responseApdu);
