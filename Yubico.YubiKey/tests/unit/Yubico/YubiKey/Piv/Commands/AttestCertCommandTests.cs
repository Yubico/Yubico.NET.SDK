...
public class AttestCertCommandTests
{
    ...
    public void CreateCommandApdu_GetClaProperty_ReturnsZero(
        int cStyle)
    {
        var command = GetCommandObject(cStyle, 0x9D);
    ...
    [InlineData(2)]
    [InlineData(3)]
    public void CreateCommandApdu_GetInsProperty_ReturnsHexF9(
        int cStyle)
    {
        var command = GetCommandObject(cStyle, 0x9E);
        var cmdApdu = command.CreateCommandApdu();
    ...
    public void CreateCommandApdu_GetP1Property_ReturnsSlotNum(
        int cStyle,
        byte slotNum)
    {
    ...
    public void CreateCommandApdu_GetP2Property_ReturnsZero(
        int cStyle)
    {
        var command = GetCommandObject(cStyle, 0x9A);
        var cmdApdu = command.CreateCommandApdu();
    ...
    public void CreateCommandApdu_GetNc_ReturnsZero(
        int cStyle)
    {
        var command = GetCommandObject(cStyle, 0x9C);
        var cmdApdu = command.CreateCommandApdu();
    ...
    private static CreateAttestationStatementCommand GetCommandObject(
