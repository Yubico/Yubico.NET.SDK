...
#pragma warning restore CS8625
    ...
    public void ConstructorSingle_ResponseApdu_SetsStatusCorrectly(
        int responseFlag,
    ...
    [InlineData(ApduNoAuth, ResponseStatus.AuthenticationRequired)]
    [InlineData(ApduError, ResponseStatus.Failed)]
    public void ConstructorMutual_ResponseApdu_SetsStatusCorrectly(
        int responseFlag,
        ResponseStatus status)
    {
        var responseApdu = GetResponseApdu(responseFlag);
    ...
    public void ConstructorSingle_ResponseApdu_SetsStatusWordCorrectly(
        int responseFlag,
        short statusWord)
    {
        var responseApdu = GetResponseApdu(responseFlag);
    ...
    [InlineData(ApduNoAuth, SWConstants.ConditionsNotSatisfied)]
    [InlineData(ApduError, SWConstants.FunctionNotSupported)]
    public void ConstructorMutual_ResponseApdu_SetsStatusWordCorrectly(
        int responseFlag,
        short statusWord)
    {
        var responseApdu = GetResponseApdu(responseFlag);
        ...
        int responseFlag)
    {
        ...
        var noAuthSw1 = unchecked((byte)(SWConstants.ConditionsNotSatisfied >> 8));
        var noAuthSw2 = unchecked((byte)SWConstants.ConditionsNotSatisfied);
        var errorSw1 = unchecked((byte)(SWConstants.FunctionNotSupported >> 8));
