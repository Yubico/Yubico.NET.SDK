...
public class DecryptCommandTests
{
    ...
    public void ClassType_DerivedFromPivCommand_IsTrue(
        KeyType keyType)
    {
        var dataToDecrypt = PivCommandResponseTestData.GetEncryptedBlock(keyType);
...
#pragma warning restore CS8625
    ...
    public void Constructor_BadData_ThrowsException(
        int badFlag)
    {
        var dataToDecrypt = PivCommandResponseTestData.GetEncryptedBlock(KeyType.RSA2048);
        if (badFlag >= 0)
        {
...
#pragma warning restore CS8625
    ...
    {
        var dataToDecrypt = PivCommandResponseTestData.GetEncryptedBlock(KeyType.RSA1024);
    ...
    public void CreateCommandApdu_GetClaProperty_ReturnsZero(
        KeyType keyType)
    {
        var cmdApdu = GetDecryptCommandApdu(0x86, keyType);
    ...
    public void CreateCommandApdu_GetInsProperty_ReturnsHex87(
        KeyType keyType)
    {
        var cmdApdu = GetDecryptCommandApdu(0x90, keyType);
    ...
    {
        var cmdApdu = GetDecryptCommandApdu(0x91, expectedAlgorithm);
    ...
    public void CreateCommandApdu_GetP2Property_ReturnsSlotNum(
        ...
        KeyType keyType)
    {
        var cmdApdu = GetDecryptCommandApdu(slotNumber, keyType);
    ...
    public void CreateCommandApdu_GetNcProperty_ReturnsCorrect(
        ...
        int expected)
    {
        var cmdApdu = GetDecryptCommandApdu(0x94, keyType);
    ...
    public void CreateCommandApdu_GetNeProperty_ReturnsZero(
        KeyType keyType)
    {
        var cmdApdu = GetDecryptCommandApdu(0x95, keyType);
    ...
    public void CreateCommandApdu_GetData_ReturnsCorrect(
        KeyType keyType)
    {
        var prefix = GetDecryptDataPrefix(keyType);
        var encryptedData = PivCommandResponseTestData.GetEncryptedBlock(keyType);

        var expected = new List<byte>(prefix);
        expected.AddRange(encryptedData);

        var cmdApdu = GetDecryptCommandApdu(0x9C, keyType);
    ...
    public void CreateResponseForApdu_ReturnsCorrectType()
    {
        ...
        var command = GetCommandObject(0x86, KeyType.RSA1024);
    ...
    private static CommandApdu GetDecryptCommandApdu(
        byte slotNumber,
        KeyType keyType)
    {
    ...
    private static AuthenticateDecryptCommand GetCommandObject(
        byte slotNumber,
        KeyType keyType)
    {
        var dataToDecrypt = PivCommandResponseTestData.GetEncryptedBlock(keyType);
    ...
    private static byte[] GetDecryptDataPrefix(
        KeyType keyType)
    {
