...
#pragma warning restore CS0618 // Type or member is obsolete
    ...
    [InlineData(4, PivDataTag.Retired10)]
    public void CreateCommandApdu_GetInsProperty_ReturnsHexCB(
        int cStyle,
        PivDataTag tag)
    {
        var cmdApdu = GetDataCommandApdu(cStyle, tag);
    ...
    public void CreateCommandApdu_GetP1Property_ReturnsHex3F(
        int cStyle,
        PivDataTag tag)
    {
        var cmdApdu = GetDataCommandApdu(cStyle, tag);
    ...
    public void CreateCommandApdu_GetP2Property_ReturnsHexFF(
        int cStyle,
        PivDataTag tag)
    {
        var cmdApdu = GetDataCommandApdu(cStyle, tag);
    ...
    public void CreateCommandApdu_GetLc_ReturnsCorrect(
        int cStyle,
        PivDataTag tag,
        int expectedLength)
    {
    ...
    public void GetCommandApdu_Data_Correct(
        PivDataTag tag)
    {
        var cmdApdu = GetDataCommandApdu(4, tag);
    ...
    {
        var cmdApdu = GetDataCommandApdu(2, PivDataTag.Discovery);
    ...
    [InlineData(3)]
    [InlineData(4)]
    public void Constructor_BadTag_CorrectException(
        int cStyle)
    {
    ...
    public void IntTag_InvalidTag_Exception(
        int tag)
    {
    ...
    public void IntTag_CmdApdu_Correct(
        int tag)
    {
        var command = new GetDataCommand(tag);
    ...
    private static CommandApdu GetDataCommandApdu(
        int cStyle,
        PivDataTag tag)
    {
    ...
    // properties later.
    private static GetDataCommand GetCommandObject(
        int cStyle,
        PivDataTag tag)
    {
        GetDataCommand cmd;
