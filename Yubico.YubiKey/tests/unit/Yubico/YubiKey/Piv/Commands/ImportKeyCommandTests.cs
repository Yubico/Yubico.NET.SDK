...
{
    public class ImportKeyCommandTests
    {
        [Theory]
        ...
        public void ClassType_DerivedFromPivCommand_IsTrue(int cStyle, PivAlgorithm algorithm)
        {
...
#pragma warning restore CS8625
        ...
        {
#pragma warning disable CS8625 // testing null input, disable warning that null is passed to non-nullable arg.
            _ = Assert.Throws<ArgumentNullException>(() => new ImportAsymmetricKeyCommand(privateKey: null)
            {
                SlotNumber = 0x87,
...
#pragma warning restore CS8625
        ...
        {
            var keyData = GetKeyData(PivAlgorithm.EccP256);
        ...
        public void CreateCommandApdu_GetClaProperty_ReturnsZero(int cStyle)
        {
            var cmdApdu = GetImportKeyCommandApdu(
                cStyle, slotNumber: 0x94, PivAlgorithm.EccP256, PivPinPolicy.Default, PivTouchPolicy.Never);
        ...
        public void CreateCommandApdu_GetInsProperty_ReturnsHexFE(int cStyle)
        {
            ...
            Assert.Equal(expected: 0xFE, Ins);
        }
        ...
        [InlineData(3, PivAlgorithm.Rsa1024)]
        [InlineData(4, PivAlgorithm.Rsa2048)]
        public void CreateCommandApdu_GetP1Property_ReturnsAlgorithm(int cStyle, PivAlgorithm algorithm)
        {
            var cmdApdu = GetImportKeyCommandApdu(
                cStyle,
                slotNumber: 0x9E,
        ...
        [Theory]
        [InlineData(1, PivAlgorithm.Rsa1024, PivPinPolicy.None, PivTouchPolicy.None, 0)]
        [InlineData(2, PivAlgorithm.Rsa2048, PivPinPolicy.None, PivTouchPolicy.Default, 0)]
        [InlineData(3, PivAlgorithm.EccP256, PivPinPolicy.None, PivTouchPolicy.Never, 3)]
        [InlineData(1, PivAlgorithm.EccP384, PivPinPolicy.None, PivTouchPolicy.Always, 3)]
        [InlineData(2, PivAlgorithm.Rsa1024, PivPinPolicy.None, PivTouchPolicy.Cached, 3)]
        [InlineData(3, PivAlgorithm.Rsa2048, PivPinPolicy.Default, PivTouchPolicy.None, 0)]
        [InlineData(1, PivAlgorithm.EccP256, PivPinPolicy.Default, PivTouchPolicy.Default, 0)]
        [InlineData(2, PivAlgorithm.EccP384, PivPinPolicy.Default, PivTouchPolicy.Never, 3)]
        [InlineData(3, PivAlgorithm.Rsa1024, PivPinPolicy.Default, PivTouchPolicy.Always, 3)]
        [InlineData(1, PivAlgorithm.Rsa2048, PivPinPolicy.Default, PivTouchPolicy.Cached, 3)]
        [InlineData(2, PivAlgorithm.EccP256, PivPinPolicy.Never, PivTouchPolicy.None, 3)]
        [InlineData(3, PivAlgorithm.EccP384, PivPinPolicy.Never, PivTouchPolicy.Default, 3)]
        [InlineData(1, PivAlgorithm.Rsa1024, PivPinPolicy.Never, PivTouchPolicy.Never, 6)]
        [InlineData(2, PivAlgorithm.Rsa2048, PivPinPolicy.Never, PivTouchPolicy.Always, 6)]
        [InlineData(3, PivAlgorithm.EccP256, PivPinPolicy.Never, PivTouchPolicy.Cached, 6)]
        [InlineData(1, PivAlgorithm.EccP384, PivPinPolicy.Once, PivTouchPolicy.None, 3)]
        [InlineData(2, PivAlgorithm.Rsa1024, PivPinPolicy.Once, PivTouchPolicy.Default, 3)]
        [InlineData(3, PivAlgorithm.Rsa2048, PivPinPolicy.Once, PivTouchPolicy.Never, 6)]
        [InlineData(1, PivAlgorithm.EccP256, PivPinPolicy.Once, PivTouchPolicy.Always, 6)]
        [InlineData(2, PivAlgorithm.EccP384, PivPinPolicy.Once, PivTouchPolicy.Cached, 6)]
        [InlineData(3, PivAlgorithm.Rsa1024, PivPinPolicy.Always, PivTouchPolicy.None, 3)]
        [InlineData(1, PivAlgorithm.Rsa2048, PivPinPolicy.Always, PivTouchPolicy.Default, 3)]
        [InlineData(2, PivAlgorithm.EccP256, PivPinPolicy.Always, PivTouchPolicy.Never, 6)]
        [InlineData(3, PivAlgorithm.EccP384, PivPinPolicy.Always, PivTouchPolicy.Always, 6)]
        [InlineData(1, PivAlgorithm.Rsa1024, PivPinPolicy.Always, PivTouchPolicy.Cached, 6)]
        ...
        {
            var keyData = GetKeyData(algorithm);
            var cmdApdu = GetImportKeyCommandApdu(
                cStyle,
                slotNumber: 0x8E,
                algorithm,
        ...
        [Theory]
        [InlineData(1, PivAlgorithm.Rsa1024)]
        [InlineData(2, PivAlgorithm.Rsa2048)]
        [InlineData(3, PivAlgorithm.EccP256)]
        [InlineData(4, PivAlgorithm.EccP384)]
        public void CreateCommandApdu_GetData_ReturnsKeyData(int cStyle, PivAlgorithm algorithm)
        {
            var keyData = GetKeyData(algorithm);
        ...
        {
            var keyData = GetKeyData(PivAlgorithm.EccP256);
            byte[] pinData = { 0xAA, 0x01, (byte)pinPolicy };
            byte[] touchData = { 0xAB, 0x01, (byte)touchPolicy };
        ...
        public void CreateResponseForApdu_ReturnsCorrectType()
        {
            ...
            var keyData = GetKeyData(PivAlgorithm.EccP384);
            var importKeyCommand = new ImportAsymmetricKeyCommand(
                keyData,
                PivSlot.Retired18,
                PivPinPolicy.Default,
...
#pragma warning restore IDE0017
        ...
        private static PivPrivateKey GetKeyData(PivAlgorithm algorithm)
        {
