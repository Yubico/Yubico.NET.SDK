...
public class InitializeAuthenticateManagementKeyCommandTests
{
    ...
    [InlineData(1)]
    [InlineData(2)]
    public void CreateCommandApdu_GetP1Property_ReturnsThree(
        int constructor)
    {
        var cmdApdu = GetInitAuthMgmtKeyCommandApdu(constructor);
    ...
    [InlineData(1)]
    [InlineData(2)]
    public void CreateCommandApdu_GetNc_Returns4(
        int constructor)
    {
        var cmdApdu = GetInitAuthMgmtKeyCommandApdu(constructor);
    ...
    // 0 or 1.
    private static CommandApdu GetInitAuthMgmtKeyCommandApdu(
        int constructor)
    {
