...
public class GetMetadataCommandTests
{
    ...
    [InlineData(2, 0x9C)]
    [InlineData(3, 0x9D)]
    public void CreateCommandApdu_GetInsProperty_ReturnsHexF7(
        int cStyle,
        byte slotNumber)
    {
        var cmdApdu = GetMetadataCommandApdu(cStyle, slotNumber);
    ...
    [InlineData(2, 0x93)]
    [InlineData(3, 0x94)]
    public void CreateCommandApdu_GetP2Property_ReturnsSlot(
        int cStyle,
        byte slotNumber)
    {
        var cmdApdu = GetMetadataCommandApdu(cStyle, slotNumber);
    ...
    private static CommandApdu GetMetadataCommandApdu(
        int cStyle,
        byte pivSlot)
    {
    ...
    // properties later.
    private static GetMetadataCommand GetCommandObject(
        int cStyle,
        byte slotNumber)
    {
