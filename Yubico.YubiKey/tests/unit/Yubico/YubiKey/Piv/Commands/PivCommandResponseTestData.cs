...
namespace Yubico.YubiKey.Piv.Commands
{
    ...
    {
        public static byte[] GetEncryptedBlock(PivAlgorithm algorithm)
        {
        ...
        public static byte[] GetDigestData(PivAlgorithm algorithm)
        {
            return algorithm switch
            {
        ...
        public static List<byte> GetDataCommandExpectedApduData(PivDataTag tag)
        {
            return tag switch
            {
        ...
        public static List<byte> GetDataCommandExpectedApduDataInt(int tag)
        {
            return tag switch
            {
        ...
        private static byte[] BuildPutDataEncoding(int[] format, bool isCorrect, int indexRandom)
        {
            ...
            using (tlvWriter.WriteNestedTlv(format[0]))
            {
                while (index < format.Length)
                {
                    ...
                    if (valueLen == 0)
                    {
                        tlvWriter.WriteValue(format[index], value: null);
                    }
                    else
                    {
