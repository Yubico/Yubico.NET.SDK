...
public class SetManagementKeyCommandTests
{
    ...
    [InlineData(3)]
    [InlineData(4)]
    public void CreateCommandApdu_GetInsProperty_ReturnsHexFF(
        int cStyle)
    {
        var cmdApdu = GetSetManagementKeyCommandApdu(cStyle, PivTouchPolicy.Always);
    ...
    [InlineData(3)]
    [InlineData(4)]
    public void CreateCommandApdu_GetP1Property_ReturnsHexFF(
        int cStyle)
    {
        var cmdApdu = GetSetManagementKeyCommandApdu(cStyle, PivTouchPolicy.Always);
    ...
    public void CreateCommandApdu_GetP2Property_ReturnsPolicy(
        int cStyle,
        PivTouchPolicy policy,
        byte p2Val)
    {
    ...
    [InlineData(3)]
    [InlineData(4)]
    public void CreateCommandApdu_GetNc_Returns27(
        int cStyle)
    {
        var cmdApdu = GetSetManagementKeyCommandApdu(cStyle, PivTouchPolicy.Always);
    ...
    [InlineData(3)]
    [InlineData(4)]
    public void CreateCommandApdu_GetDataProperty_ReturnsKey(
        int cStyle)
    {
    ...
    private static CommandApdu GetSetManagementKeyCommandApdu(
        int cStyle,
    ...
    private static SetManagementKeyCommand GetCommandObject(
        int cStyle,
        PivTouchPolicy touchPolicy)
    {
