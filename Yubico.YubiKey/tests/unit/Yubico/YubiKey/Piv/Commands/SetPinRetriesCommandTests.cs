...
public class SetPinRetriesCommandTests
{
    ...
    public void CreateCommandApdu_GetClaProperty_ReturnsZero(
        int cStyle)
    {
        var cmdApdu = GetPinRetriesCommandApdu(cStyle, 6, 4);
    ...
    [InlineData(7)]
    [InlineData(8)]
    public void CreateCommandApdu_GetInsProperty_ReturnsHexFA(
        int cStyle)
    {
        var cmdApdu = GetPinRetriesCommandApdu(cStyle, 22, 100);
    ...
    [InlineData(7, 44, 44)]
    [InlineData(8, 88, 3)]
    public void CreateCommandApdu_GetP1Property_ReturnsPinRetries(
        int cStyle,
        byte count,
        byte expected)
    {
        var cmdApdu = GetPinRetriesCommandApdu(cStyle, count, 11);
    ...
    [InlineData(7, 44, 3)]
    [InlineData(8, 88, 3)]
    public void CreateCommandApdu_GetP2Property_ReturnsPukRetries(
        int cStyle,
        byte count,
        byte expected)
    {
        var cmdApdu = GetPinRetriesCommandApdu(cStyle, 50, count);
    ...
    public void CreateCommandApdu_GetNc_ReturnsZero(
        int cStyle)
    {
        var cmdApdu = GetPinRetriesCommandApdu(cStyle, 255, 1);
    ...
    public void CreateCommandApdu_GetNe_ReturnsZero(
        int cStyle)
    {
        var cmdApdu = GetPinRetriesCommandApdu(cStyle, 16, 15);
    ...
    public void CreateCommandApdu_GetData_ReturnsEmpty(
        int cStyle)
    {
        var cmdApdu = GetPinRetriesCommandApdu(cStyle, 4, 255);
    ...
    [InlineData(0, 4)]
    [InlineData(4, 0)]
    public void Constructor_BadCount_CorrectException(
        byte pinCount,
        byte pukCount)
    {
    ...
    private static CommandApdu GetPinRetriesCommandApdu(
        int cStyle,
        byte pinRetries,
        byte pukRetries)
    {
