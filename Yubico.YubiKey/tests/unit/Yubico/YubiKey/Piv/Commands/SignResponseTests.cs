...
#pragma warning disable CS8625 // testing null input, disable warning that null is passed to non-nullable arg.
            _ = Assert.Throws<ArgumentNullException>(() => new AuthenticateSignResponse(responseApdu: null));
#pragma warning restore CS8625
        ...
        {
            var sigData = GetSignatureData(algorithm);
        ...
        private static byte[] GetSignatureData(PivAlgorithm algorithm)
        {
