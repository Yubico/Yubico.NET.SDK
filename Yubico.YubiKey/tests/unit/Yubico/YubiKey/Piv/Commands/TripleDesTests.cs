...
public class TripleDesTests
{
    ...
    [InlineData(23)]
    [InlineData(25)]
    public void Constructor_WrongKeyLength_ThrowsException(
        int keyLength)
    {
...
#pragma warning disable CS0618 // testing special TripleDES, disable warning about using special TripleDES
        ...
        {
            var dataLength = tDesObject.TransformBlock(dataToEncrypt, 0, 24, result, 0);
...
#pragma warning restore CS0618
    ...
    private static int GetNextKeyData(
        byte[] keyData,
        int nextIndex)
    {
    ...
    public static byte[] FixupKeyParity(
        byte[] key)
    {
