...
public class PivMetadataTests : PivSessionUnitTestBase
{
    [Fact]
    ...
    {
        FirmwareVersion = FirmwareVersion.Parse("5.2.0");
        _ = Assert.Throws<NotSupportedException>(() => PivSessionMock.GetMetadata(0x9A));
    }
