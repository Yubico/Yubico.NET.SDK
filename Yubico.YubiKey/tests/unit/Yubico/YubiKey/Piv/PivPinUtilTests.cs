...
public class PivPinUtilTests
{
    ...
    [InlineData(7)]
    [InlineData(8)]
    public void IsValidPinLength_CorrectPinLength_ReturnsTrue(
        int pinLength)
    {
    ...
    [InlineData(10)]
    [InlineData(17)]
    public void IsValidPinLength_BadPinLength_ReturnsFalse(
        int pinLength)
    {
        var isValidLength = PivPinUtilities.IsValidPinLength(pinLength);
    ...
    [InlineData(0x63CF)]
    [InlineData(0x63C0)]
    public void HasRetryCountSW_WrongPinWithRetriesStatusWord_ReturnsTrue(
        short statusWord)
    {
    ...
    public void HasRetryCountSW_NotWrongPinStatusWord_ReturnsFalse(
        short statusWord)
    {
        var result = PivPinUtilities.HasRetryCount(statusWord);
    ...
    [InlineData(0x63CF)]
    [InlineData(0x63C0)]
    public void ParseSW_WrongPin_ReturnsAuthRequired(
        short statusWord)
    {
    ...
    public void ParseSW_InvalidStatusWord_ThrowsInvalidOperationException(
        short statusWord)
    {
