...
namespace Yubico.YubiKey.Piv
{
    public class PivPublicKeyTests
    {
        ...
        public void Create_SetsEncodedCorrectly(PivAlgorithm algorithm)
        {
            ...
            var getKeyData = keyObject.PivEncodedPublicKey;
        ...
        public void Create_SetsMetadataEncodedCorrectly(PivAlgorithm algorithm)
        {
            ...
            var getKeyData = keyObject.YubiKeyEncodedPublicKey;
        ...
        public void CreateRsa_SetsModulusCorrectly(PivAlgorithm algorithm)
        {
            ...
            var getModulus = rsaObject.Modulus;

            var compareResult = modulus.Span.SequenceEqual(getModulus);
        ...
        {
            var keyData = SampleKeyPairs.GetPivPublicKey(algorithm).PivEncodedPublicKey;
            ...
            var getExponent = rsaObject.PublicExponent;

            var compareResult = exponent.Span.SequenceEqual(getExponent);
        ...
        public void CreateEcc_SetsPublicPointCorrectly(PivAlgorithm algorithm)
        {
            ...
            var getPoint = eccObject.PublicPoint;

            var compareResult = publicPoint.Span.SequenceEqual(getPoint);
        ...
        public void RsaConstructor_Components_BuildsEncoding(PivAlgorithm algorithm)
        {
            ...
            var getEncoding = rsaPublic.PivEncodedPublicKey;
        ...
        public void EccConstructor_Components_BuildsEncoding(PivAlgorithm algorithm)
        {
            ...
            var getEncoding = eccPublic.PivEncodedPublicKey;
        ...
        {
            _ = Assert.Throws<ArgumentException>(() => PivPublicKey.Create(encodedPublicKey: null));
        }
        ...
        public void Rsa_NoExpo_ThrowsExcpetion()
        {
            ...
            var badData = keyData.Slice(keyData.Length - 6);
        ...
        {
            var keyData = GetBadEncoding(algorithm);
            _ = Assert.Throws<ArgumentException>(() => PivPublicKey.Create(keyData));
        }
        ...
        {
            var modulus = GetModulus(PivAlgorithm.Rsa1024);
        ...
        private static Memory<byte> GetPoint(PivAlgorithm algorithm)
        {
            ...
            var point = keyData.Slice(start: 5);
            return point;
        }
        ...
        {
            var sliceIndex = algorithm switch
            {
        ...
        private static Memory<byte> GetBadEncoding(PivAlgorithm algorithm)
        {
            return algorithm switch
            {
                PivAlgorithm.Rsa1024 => new Memory<byte>(new byte[]
