...
namespace Yubico.YubiKey.Scp
{
    public class Scp11KeyParametersTests : IDisposable
    {
        ...
        public void Constructor_Scp11b_ValidParameters_Succeeds()
        {
            ...
            var pkSdEcka = ECPublicKeyParameters.CreateFromParameters(_sdPublicKeyParams);
            ...
            byte keyId)
        {
            ...
            var pkSdEcka = ECPublicKeyParameters.CreateFromParameters(_sdPublicKeyParams);
            var skOceEcka = ECPrivateKeyParameters.CreateFromParameters(_ocePrivateKeyParams);
