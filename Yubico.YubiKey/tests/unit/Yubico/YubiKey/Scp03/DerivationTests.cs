...
namespace Yubico.YubiKey.Scp03
{
    public class DerivationTests
    {
        ...
        private static byte[] GetCorrectDeriveOutput() => Hex.HexToBytes("45330AB30BB1A079DE030007084FA812");

        [Fact]
        public void Derive_GivenBadOutputLen_ThrowsSecureChannelException()
        {
            _ = Assert.Throws<SecureChannelException>(() => Derivation.Derive(Derivation.DDC_HOST_CRYPTOGRAM, 0x50, GetKey(), GetHostChallenge(), GetCardChallenge()));
        }
