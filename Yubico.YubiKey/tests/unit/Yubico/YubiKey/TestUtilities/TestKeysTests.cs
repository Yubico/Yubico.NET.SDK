...
public class TestKeysTests
{
    ...
    public void TestKey_GetPublicKey(
        KeyType keyType,
        bool isPrivate)
    {
    ...
    [InlineData(KeyType.X25519, false)]
    [InlineData(KeyType.X25519, true)]
    public void TestKey_GetPrivateKey(
        KeyType keyType,
        bool isPrivate)
    {
        var key = isPrivate ? TestKeys.GetTestPrivateKey(keyType) : TestKeys.GetTestPublicKey(keyType);
    ...
    [InlineData(KeyType.X25519, false)]
    [InlineData(KeyType.X25519, true)]
    public void TestKey_GetPublicPoint(
        KeyType keyType,
        bool isPrivate)
    {
        var key = isPrivate ? TestKeys.GetTestPrivateKey(keyType) : TestKeys.GetTestPublicKey(keyType);
    ...
    [InlineData(KeyType.X25519, false)]
    [InlineData(KeyType.X25519, true)]
    public void TestKey_GetPrivateValue(
        KeyType keyType,
        bool isPrivate)
    {
        var key = isPrivate ? TestKeys.GetTestPrivateKey(keyType) : TestKeys.GetTestPublicKey(keyType);
