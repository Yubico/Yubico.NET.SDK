...
public class RegistrationDataTests
{
    ...
    public void Constructor_GivenGoodData_SetsKeyHandle()
    {
        ...
        var expected = GetKeyHandle(true, out _);
    ...
    {
        var appId = Hex.HexToBytes(GetAppId(true));
        var clientDataHash = Hex.HexToBytes(GetClientDataHash(true));
    ...
    {
        var appId = Hex.HexToBytes(GetAppId(false));
        var clientDataHash = Hex.HexToBytes(GetClientDataHash(true));
    ...
    public static byte[] GetEncodedRegistration(
        bool validPubKey,
        bool validKeyHandle)
    {
    ...
    public static byte[] GetPubKeyArray(
        bool isValid)
    {
    ...
    public static string GetAuthSignature(
        out U2fAuthenticationType controlByte,
        out int counter)
    {
        ...
        return
            "304502206190bee2c2ed0dd524c88f0848ae0e779b1167f0524da2329d1e0c80117a608f022100a9e86d105f3d937469a0188be886aaad633e4c8a221ba01873d712cce97778bb";
    }

    public static byte[] GetAuthSignatureArray(
        out U2fAuthenticationType controlByte,
        out int counter)
    {
    ...
    public static string GetKeyHandle(
        bool isValid,
        out string handleLength)
    {
        handleLength = "08";
        if (isValid)
        {
            handleLength = "40";
            return
                "6c61ddbf52b4d1597926c467bf279a96fc1bce0f6044c1482c88dea1097e06ef6bc491cfc82e74b33d2fbc115f5c60046d9dbc1935d78bce98d22af92465e443"
                    .ToUpper();
        }
    ...
    public static byte[] GetKeyHandleArray(
        bool isValid,
        out byte handleLength)
    {
    ...
    {
        return
            ""
                .ToUpper();
    }
    ...
    {
        return
            "3046022100d778d422916e47baf8935d8a4ac9e5a48cfc45a125ee12538d226be7e5ba73c4022100efd29f8b3b81d5f56d9f8f54586197f300b6211668ea4e53a36120e8cc0c2d11"
                .ToUpper();
    }

    public static string GetClientDataHash(
        bool isValid)
    {
        if (isValid)
        {
    ...
    public static byte[] GetClientDataHashArray(
        bool isValid)
    {
    ...
    public static byte[] GetAppIdArray(
        bool isValid)
    {
