...
public class Aes128CredentialWithSecretsTests
{
    ...
    private Aes128CredentialWithSecrets _aes128Cred => new(
        _password,
        _encKey,
        _macKey,
        _label,
    ...
    [InlineData(15)]
    [InlineData(17)]
    public void Constructor_InvalidEncKeyLength_ThrowsArgException(
        int len)
    {
        var invalidEncKey = new byte[len];

        _ = Assert.Throws<ArgumentException>(() => new Aes128CredentialWithSecrets(
            _password,
            invalidEncKey,
            _macKey,
            _label,
    ...
    [InlineData(15)]
    [InlineData(17)]
    public void Constructor_InvalidMacKeyLength_ThrowsArgException(
        int len)
    {
