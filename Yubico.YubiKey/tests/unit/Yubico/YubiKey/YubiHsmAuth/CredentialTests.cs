...
public class CredentialTests
{
    ...
    public void Constructor_LabelInvalidLength_ThrowsArgException(
        int strLength)
    {
        var expectedLabel = new string('a', strLength);
    ...
    public void KeyType_SetNegative1_ThrowsArgOutOfRange()
    {
        ...
        _ = Assert.Throws<ArgumentOutOfRangeException>(() => cred.KeyType = invalidKeyType);
    }
    ...
    public void Label_SetGetLabel_ReturnsMatchingString(
        int labelLength)
    {
        var expectedLabel = new string('a', labelLength);
    ...
    public void Label_SetNonUtf8Character_ThrowsArgException()
    {
        ...
        _ = Assert.ThrowsAny<ArgumentException>(() => cred.Label = expectedLabel);
    }

    [Theory]
    [InlineData(Credential.MinLabelByteCount - 1)]
    [InlineData(Credential.MaxLabelByteCount + 1)]
    public void Label_SetInvalidLabelLength_ThrowsArgOutOfRangeException(
        int labelLength)
    {
        var expectedLabel = new string('a', labelLength);
        ...
        _ = Assert.Throws<ArgumentOutOfRangeException>(() => cred.Label = expectedLabel);
    }
