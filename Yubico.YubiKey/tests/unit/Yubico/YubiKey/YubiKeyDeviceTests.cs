...
public class YubiKeyDeviceTests
{
    ...
    public void SetEnabledNfcCapabilities_NoConnections_ThrowsException()
    {
        ...
        _ = Assert.Throws<NotSupportedException>(() => ykDevice.SetEnabledNfcCapabilities(YubiKeyCapabilities.Piv));
    }
    ...
    public void SetEnabledUsbCapabilities_NoConnections_ThrowsException()
    {
        ...
        _ = Assert.Throws<NotSupportedException>(() => ykDevice.SetEnabledUsbCapabilities(YubiKeyCapabilities.Piv));
    }

    [Theory]
    [InlineData(-1)]
    [InlineData(256)]
    public void SetChallengeResponseTimeout_InvalidSecondsValue_ThrowsException(
        int seconds)
    {
        var ykDevice = new YubiKeyDevice(null, null, null, new YubiKeyDeviceInfo());

        _ = Assert.Throws<ArgumentOutOfRangeException>(() => ykDevice.SetChallengeResponseTimeout(seconds));
    }
    ...
    public void SetChallengeResponseTimeout_NoConnections_ThrowsException()
    {
        ...
        _ = Assert.Throws<NotSupportedException>(() => ykDevice.SetChallengeResponseTimeout(15));
    }

    [Theory]
    [InlineData(ushort.MinValue - 1)]
    [InlineData(ushort.MaxValue + 1)]
    public void SetAutoEjectTimeout_InvalidSecondsValue_ThrowsException(
        int seconds)
    {
        var ykDevice = new YubiKeyDevice(null, null, null, new YubiKeyDeviceInfo());

        _ = Assert.Throws<ArgumentOutOfRangeException>(() => ykDevice.SetAutoEjectTimeout(seconds));
    }
    ...
    public void SetAutoEjectTimeout_NoConnections_ThrowsException()
    {
        ...
        _ = Assert.Throws<NotSupportedException>(() => ykDevice.SetAutoEjectTimeout(15));
    }
    ...
    public void SetDeviceFlags_NoConnections_ThrowsException()
    {
        ...
        _ = Assert.Throws<NotSupportedException>(() => ykDevice.SetDeviceFlags(DeviceFlags.None));
    }
    ...
    public void LockConfiguration_SetEmptySpan_ThrowsArgException()
    {
        ...
        _ = Assert.Throws<ArgumentException>(() => ykDevice.LockConfiguration(ReadOnlySpan<byte>.Empty));
    }
    ...
    public void LockConfiguration_SetAllZero_ThrowsArgException()
    {
        ...
        _ = Assert.Throws<ArgumentException>(() => ykDevice.LockConfiguration(new byte[16]));
    }
    ...
    public void LockConfiguration_NoConnections_ThrowsException()
    {
        ...
        _ = Assert.Throws<NotSupportedException>(() => ykDevice.LockConfiguration(lockCode));
    }
