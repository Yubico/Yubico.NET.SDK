...
namespace Yubico.YubiKey
{
    ...
    [Fact]
    public void ApplicationIds_ReturnsReadOnlyDictionary()
    {
        var result = YubiKeyApplicationExtensions.ApplicationIds;
        Assert.IsType<ReadOnlyDictionary<YubiKeyApplication, ReadOnlyMemory<byte>>>(result);
    }
    ...
    {
        var result = YubiKeyApplicationExtensions.GetById(applicationId);
    ...
    public void GetById_ThrowsForUnknownApplicationId()
    {
        ...
        Assert.Throws<ArgumentException>(() => YubiKeyApplicationExtensions.GetById(unknownId));
    }
    }
}
