...
public static class BadAttestationPairs
{
    ...
    public static void GetPair1024(
        out string privateKeyPem,
        out string certPem)
    {
        privateKeyPem =
    ...
    public static void GetPair2048Version1(
        out string privateKeyPem,
        out string certPem)
    {
        privateKeyPem =
    ...
    // Get a pair that is valid, except the cert is version 1.
    public static void GetPair256Version1(
        out string privateKeyPem,
        out string certPem)
    {
        privateKeyPem =
    ...
    // Get a pair that is valid, except the cert is version 1.
    public static void GetPair384Version1(
        out string privateKeyPem,
        out string certPem)
    {
        privateKeyPem =
    ...
    public static void GetMix256And384(
        out string privateKeyPem,
        out string certPem)
    {
        privateKeyPem =
    ...
    // different key.
    public static void GetMix2048And2048(
        out string privateKeyPem,
        out string certPem)
    {
        privateKeyPem =
    ...
    public static void Get2048BigIssuerName(
        out string privateKeyPem,
        out string certPem)
    {
        privateKeyPem =
