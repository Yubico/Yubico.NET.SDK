...
public class DeviceReset
{
    ...
    /// </summary>
    public static IYubiKeyDevice ResetAll(
        IYubiKeyDevice key)
    {
    ...
    /// </summary>
    public static IYubiKeyDevice ResetPiv(
        IYubiKeyDevice key)
    {
    ...
    /// </summary>
    public static IYubiKeyDevice ResetOath(
        IYubiKeyDevice key)
    {
    ...
    /// </summary>
    public static IYubiKeyDevice ResetYubiHsmAuth(
        IYubiKeyDevice key)
    {
    ...
    /// </remarks>
    public static IYubiKeyDevice EnableAllCapabilities(
        IYubiKeyDevice key)
    {
        var serialNumber =
