...
public class Fido2ResetForTest
{
    ...
    private readonly KeyEntryData _keyEntryData = new();
    ...
    private void YubiKeyRemoved(
        object? sender,
        YubiKeyDeviceEventArgs eventArgs)
    {
    ...
    public bool ResetForTestKeyCollector(
        KeyEntryData keyEntryData)
    {
        return ResetKeyCollector(keyEntryData, _pin);
    }

    public static bool ResetForTestKeyCollectorDelegate(
        KeyEntryData keyEntryData)
    {
        return ResetKeyCollector(keyEntryData, null);
    }

    public static bool ResetKeyCollector(
        KeyEntryData keyEntryData,
    ...
    private static void WriteMessageBox(
        string msg)
    {
