...
namespace Yubico.YubiKey.TestUtilities
{
    ...
    {
        private const string KeyRsaPublic1024 =
            "-----BEGIN PUBLIC KEY-----" +
        ...
        private const string KeyRsaPrivate1024 =
            "-----BEGIN PRIVATE KEY-----" +
        ...
        private const string KeyRsaPublic2048 =
            "-----BEGIN PUBLIC KEY-----" +
        ...
        private const string KeyRsaPrivate2048 =
            "-----BEGIN PRIVATE KEY-----" +
        ...
        private const string KeyRsaPublic3072 =
            "-----BEGIN PUBLIC KEY-----" +
        ...
        private const string KeyRsaPrivate3072 =
            "-----BEGIN PRIVATE KEY-----" +
        ...
        private const string KeyRsaPublic4096 =
            "-----BEGIN PUBLIC KEY-----" +
        ...
        private const string KeyRsaPrivate4096 =
            "-----BEGIN PRIVATE KEY-----" +
        ...
        private const string KeyEccPublicP256 =
            "-----BEGIN PUBLIC KEY-----" +
        ...
        private const string KeyEccPrivateP256 =
            "-----BEGIN PRIVATE KEY-----" +
        ...
        private const string KeyEccPublicP384 =
            "-----BEGIN PUBLIC KEY-----" +
        ...
        private const string KeyEccPrivateP384 =
            "-----BEGIN PRIVATE KEY-----" +
        ...
        private const string CertRsa1024 =
            "-----BEGIN CERTIFICATE-----" +
        ...
        private const string CertRsa1024WithAttestation =
            "-----BEGIN CERTIFICATE-----" +
        ...
        private const string CertRsa2048WithAttestation =
            "-----BEGIN CERTIFICATE-----" +
        ...
        private const string CertRsa3072 =
            "-----BEGIN CERTIFICATE-----" +
        ...
        private const string CertRsa4096 =
            "-----BEGIN CERTIFICATE-----" +
        ...
        private const string CertEccP384 =
            "-----BEGIN CERTIFICATE-----" +
        ...
        private const string CertEccP384WithAttestation =
            "-----BEGIN CERTIFICATE-----" +
        ...
        private const string CertEccP256 =
            "-----BEGIN CERTIFICATE-----" +
        ...
        private const string CertEccP256WithAttestation =
            "-----BEGIN CERTIFICATE-----" +
            ...
            out string privateKey)
        {
            switch (algorithm)
            {
                ...
                case PivAlgorithm.Rsa1024:
                    if (validAttest)
                    {
                        cert = CertRsa1024WithAttestation;
                    }
                    else
                    {
                        cert = CertRsa1024;
                ...
                case PivAlgorithm.Rsa2048:
                    if (validAttest)
                    {
                        cert = CertRsa2048WithAttestation;
                    }
                    else
                    {
                        cert = CertRsa2048;
                ...
                case PivAlgorithm.EccP256:
                    if (validAttest)
                    {
                        cert = CertEccP256WithAttestation;
                    }
                    else
                    {
                        cert =
                ...
                case PivAlgorithm.EccP384:
                    if (validAttest)
                    {
                        cert = CertEccP384WithAttestation;
                    }
                    else
                    {
                        cert = CertEccP384;
        ...
        public static PivPublicKey GetPivPublicKey(PivAlgorithm algorithm) =>
            ConvertPemKeyString(GetPemKeyString(algorithm)).GetPivPublicKey();
        ...
        public static PivPrivateKey GetPivPrivateKey(PivAlgorithm algorithm) =>
            ConvertPemKeyString(GetPemKeyString(algorithm)).GetPivPrivateKey();
