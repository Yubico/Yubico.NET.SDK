...
public static class TestKeys
{
    ...
    public static TestKey GetTestPrivateKey(
        ...
        int? index = null)
    {
        return TestKey.LoadPrivateKey(keyType, index);
    }
    ...
    public static (TestKey testPublicKey, TestKey testPrivateKey) GetKeyPair(
        ...
        int index2 = 0)
    {
        return (GetTestPublicKey(keyType, index1), GetTestPrivateKey(keyType, index2));
    }
    ...
    public static TestKey GetTestPublicKey(
        ...
        int? index = null)
    {
        return TestKey.LoadPublicKey(keyType, index);
    }
    ...
    /// <returns>TestCertificate instance</returns>
    /// s
    public static TestCertificate GetTestCertificate(
        KeyType curve,
        bool isAttestation = false)
    {
        return TestCertificate.Load(curve, isAttestation);
    }
}
