...
#pragma warning restore CS8629
    ...
    public static int? GetNullableIntPropertyValue(IntPtr device, string propertyName)
    {
        ...
        try
        {
            ...
            IntPtr propertyRef = PlatformInterop.MacOS.IOKitFramework.NativeMethods.IOHIDDeviceGetProperty(device, stringRef);
            ...
            if (!NativeMethods.CFNumberGetValue(propertyRef, kCFNumberTypeSignedInt, numberBytes))
            {
                return 0;
            }
        ...
        finally
        {
            ...
            {
                NativeMethods.CFRelease(stringRef);
            }
        }
    }
}