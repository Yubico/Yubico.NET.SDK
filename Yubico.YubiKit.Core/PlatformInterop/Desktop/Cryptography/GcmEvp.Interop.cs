...
internal static partial class NativeMethods
{
    ...
    [DllImport(Libraries.NativeShims, EntryPoint = "Native_EVP_CIPHER_CTX_new", ExactSpelling = true,
    ...
    [DllImport(Libraries.NativeShims, EntryPoint = "Native_EVP_CIPHER_CTX_free", ExactSpelling = true,
        CharSet = CharSet.Ansi)]
    [DefaultDllImportSearchPaths(DllImportSearchPath.SafeDirectories)]
    ...
    [DllImport(Libraries.NativeShims, EntryPoint = "Native_EVP_Aes256Gcm_Init", ExactSpelling = true,
        CharSet = CharSet.Ansi)]
    [DefaultDllImportSearchPaths(DllImportSearchPath.SafeDirectories)]
    ...
    // This returns 1 for success, or 0 for an error.
    [DllImport(Libraries.NativeShims, EntryPoint = "Native_EVP_Update", ExactSpelling = true,
        CharSet = CharSet.Ansi)]
    [DefaultDllImportSearchPaths(DllImportSearchPath.SafeDirectories)]
    ...
    [DllImport(Libraries.NativeShims, EntryPoint = "Native_EVP_Final_ex", ExactSpelling = true,
        CharSet = CharSet.Ansi)]
    [DefaultDllImportSearchPaths(DllImportSearchPath.SafeDirectories)]
    ...
    [DllImport(Libraries.NativeShims, EntryPoint = "Native_EVP_CIPHER_CTX_ctrl", ExactSpelling = true,
        CharSet = CharSet.Ansi)]
    [DefaultDllImportSearchPaths(DllImportSearchPath.SafeDirectories)]
