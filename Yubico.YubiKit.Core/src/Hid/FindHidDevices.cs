...
public class FindHidDevices : IFindHidDevices
{
    private static readonly ILogger<FindHidDevices> Logger = YubiKitLogging.CreateLogger<FindHidDevices>();
    ...
    private static IReadOnlyList<IHidDevice> FindAll()
    {
