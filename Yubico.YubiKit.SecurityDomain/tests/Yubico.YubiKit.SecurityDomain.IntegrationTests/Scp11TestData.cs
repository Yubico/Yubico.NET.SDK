...
{
    public static readonly byte[] OceCerts = // [0] Root CA, [1] Intermediate CA
        """
            -----BEGIN CERTIFICATE-----
    ...
    public static readonly byte[] Oce = Convert.FromBase64String(
        """
    ...
    public static readonly char[] OcePassword = "password".ToCharArray();
}