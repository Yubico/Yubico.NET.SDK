...
|---|---|---|---|---|
| PIV (ISC-47/54) | 4 | 4 | PASS / PASS | 132/132 |
| OATH (ISC-48/55) | 2 | 2 | PASS / PASS | 100/100 |
| YubiOTP (ISC-49/56) | 2 | 2 | PASS / PASS WITH NOTES | 147/147 |
| YubiHSM Auth (ISC-50/57) | 2 | 1 | PASS / PASS | 72/72 (+ hardware Counter-field verification, see ISC-33..35.1) |
| SecurityDomain — exception taxonomy (ISC-52/59 partial) | 3 | 2 | PASS / PASS | 42/42 + live hardware SCP03/SCP11 smoke re-run, 25/25 |
| OpenPGP — exception taxonomy (ISC-52/59 partial) | 1 | 1 | PASS / PASS | 99/99 |
