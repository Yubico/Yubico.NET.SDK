...
Generated: 2026-01-19T15:20:58.133Z
Prompt: ---
type: progress
...
### Tasks
- [ ] 1.1: Add ConnectionType property to YubiKeyTestState
- [ ] 1.2: Update constructor to accept ConnectionType parameter
- [ ] 1.3: Update Serialize method to include ConnectionType
- [ ] 1.4: Update Deserialize method to use composite cache key
- [ ] 1.5: Add GetCacheKey helper method
- [ ] 1.6: Update ToString to include ConnectionType
- [ ] 1.7: Refactor YubiKeyDeviceCache to use composite key (serialNumber:connectionType)
- [ ] 1.8: Build and verify compilation
- [ ] 1.9: Commit: `feat(tests): add ConnectionType to YubiKeyTestState`
...
### Tasks
- [ ] 2.1: Add using directive for Yubico.YubiKit.Core.Interfaces
- [ ] 2.2: Update InitializeDevicesAsync to pass device.ConnectionType to YubiKeyTestState constructor
- [ ] 2.3: Update logging to show ConnectionType
- [ ] 2.4: Build and verify
- [ ] 2.5: Commit: `feat(tests): create per-transport YubiKeyTestState during discovery`

### Notes
- `YubiKey.FindAllAsync()` already returns multiple entries per physical device (one per transport)
- Use `device.ConnectionType` directly — no need to enumerate transports ourselves
...
### Tasks
- [ ] 3.1: Add using directive for Yubico.YubiKit.Core.Interfaces
- [ ] 3.2: Add ConnectionType property (default ConnectionType.Unknown = any)
- [ ] 3.3: Update GetData to pass ConnectionType to FilterDevices
- [ ] 3.4: Update GetFilterCriteriaDescription call
- [ ] 3.5: Commit: `feat(tests): add ConnectionType property to WithYubiKeyAttribute`

### Notes
- Build may fail after this phase until Phase 4 completes
...
### Tasks
- [ ] 4.1: Add ConnectionType parameter to FilterDevices signature
- [ ] 4.2: Add ConnectionType filtering logic (skip if Unknown)
- [ ] 4.3: Add ConnectionType parameter to GetFilterCriteriaDescription
- [ ] 4.4: Add ConnectionType to criteria description output
- [ ] 4.5: Build and verify
- [ ] 4.6: Commit: `feat(tests): add ConnectionType filtering to device discovery`
...
### Tasks
- [ ] 5.1: Simplify WithManagementAsync to use device.ConnectAsync() (no switch needed)
- [ ] 5.2: Simplify WithConnectionAsync to use device.ConnectAsync()
- [ ] 5.3: Add WithSmartCardConnectionAsync for explicit SmartCard connections
- [ ] 5.4: Build and verify
- [ ] 5.5: Commit: `feat(tests): simplify WithManagementAsync to use device.ConnectAsync()`

### Notes
- Key insight: `IYubiKey.ConnectAsync()` already uses `device.ConnectionType` automatically
...
### Tasks
- [ ] 6.1: Verify no code references ManagementTestState
- [ ] 6.2: Verify no code references TestState
- [ ] 6.3: Delete ManagementTestState.cs
- [ ] 6.4: Delete Infrastructure/TestState.cs
- [ ] 6.5: Build and verify no references
- [ ] 6.6: Commit: `chore(tests): remove unused ManagementTestState and TestState classes`
