...
internal interface IArkgPrimitives
{
    ...
    /// <remarks>
    /// The returned array is owned by the caller and should be zeroed after use via
    ...
    /// Both returned arrays are owned by the caller and should be zeroed after use.
    /// </returns>
