...
#pragma warning restore CA1043
    ...
    /// </summary>
    public string SupportedCharactersString => new(_byChar.Keys.ToArray());
...
#pragma warning restore CA1819
    ...
    ///     instance.
    /// </exception>
    public string GetString(byte[] hidCodes) => new(hidCodes.Select(b => this[b]).ToArray());
